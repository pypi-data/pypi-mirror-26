...
def get_word(size):
    ...
    try:
        ...
        if size is 0:
            ...
            random_word = linecache.getline('dictionary.txt', random.randint(1, 8829)).split()[0]
...
def generate(pattern=None, dictionary=None, digits=None, characters=None):
    try:
        if pattern is None and dictionary is None and digits is None and characters is None:
