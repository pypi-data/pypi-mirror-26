...
class HTTPConnection(object):
    ...
    def _on_write_complete(self):
        ...
        # simultaneously write more resources and finish the request.  If
        # there is still resources in the IOStream, a future
        ...
        if self._request.method in ("POST", "PATCH", "PUT"):
            if content_type.startswith("application/x-www-form-urlencoded"):
                ...
                for name, values in arguments.iteritems():
                    ...
                    if values:
                        self._request.arguments.setdefault(name, []).extend(
                            values)
            elif content_type.startswith("multipart/form-resources"):
                ...
                for field in fields:
                    ...
                    logging.warning("Invalid multipart/form-resources")
        self.request_callback(self._request)
