...
required for django-simple-shop tests to execute.
...
# Minimum settings required for django-simple-shop to work.
SETTINGS_DICT = {
    'BASE_DIR': APP_DIR,
    'INSTALLED_APPS': (
        'django_shop',
    ...
    'ROOT_URLCONF': 'django_shop.tests.urls',
    'DATABASES': {
        'default': {
...
def run_tests():
    ...
    failures = test_runner.run_tests(['django_shop.tests'])
