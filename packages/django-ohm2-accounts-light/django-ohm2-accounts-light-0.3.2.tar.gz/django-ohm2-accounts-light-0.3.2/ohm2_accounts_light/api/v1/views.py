...
def signup_and_get_token_patched(request):
	return process_signup_and_get_token(request, request.POST)
...
def login_and_get_token_patched(request):
	return process_login_and_get_token(request, request.POST)
...
def facebook_login_and_get_token_patched(request):
	return process_facebook_login_and_get_token(request, request.POST)
...
def google_plus_login_and_get_token_patched(request):
	return process_google_plus_login_and_get_token(request, request.POST)
