...
class SendCodeRequest(TLObject):
    ...
    def __bytes__(self):
        assert (self.allow_flashcall and self.current_number) or (not self.allow_flashcall and not self.current_number), 'allow_flashcall, current_number parameters must all be False-y (like None) or all me True-y'
        return b''.join((
            b'\xec\xf0\xae\x86',
