...
class EditMessageRequest(TLObject):
    ...
    def __bytes__(self):
        return b''.join((
            b'\xdd\xb8\xd1\x05',
            struct.pack('<I', (2 if self.no_webpage else 0) | (4096 if self.stop_geo_live else 0) | (2048 if self.message else 0) | (4 if self.reply_markup else 0) | (8 if self.entities else 0) | (8192 if self.geo_point else 0)),
            bytes(self.peer),
