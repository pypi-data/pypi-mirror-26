...
#        nx.write_graphml(self.graph, filename)
    ...
    def drawReactionNodes(self, reactionNodeList):
        ...
        for start, end  in self.graph.edges_iter():
            ...
            if self.graph[start][end].has_key("graphics"):
                continue
        ...
        for nodeID, label in result:
            ...
            if self.graph.node[nodeID].has_key("graphics"):
                continue
    ...
    def drawReactions(self, reactionIDlist):
        ...
        self.drawReactionNodes(map(str,flatten(result)))
...
#        pprint(reactionIDtoECdict)
        self.drawEnzymes(reactionIDtoECdict.values())
