...
def default_values( target: T, default: Optional[ Union[ T, type ] ] = None ) -> T:
    ...
    #     raise ValueError("Attempting to set the defaults for the value «{}», of type «{}», but the value provided, «{}», of type «{}», is not commensurate with this.".format(target, type(target), default, type(default)))
