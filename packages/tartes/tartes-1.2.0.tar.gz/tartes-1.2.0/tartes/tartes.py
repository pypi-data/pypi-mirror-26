...
:param refrac_index: real and imaginary parts of the refractive index for each wavelength or a string "p2016" for Picard et al. 2016 or w2008 for Warren and Brandt 2008 or w1995 for Warren, 1984 modified as explained on Warren web site.
...
"""
    ...
    nlyrmax = empty_like(wavelength, dtype=int32)
...
"""
    ...
    if refrac_index is None or refrac_index == "w2008":
        ...
        refrac_index = refice2016(wavelength)  # should be cached when the same wavelengths are used
    elif callable(refrac_index):
        refrac_index = refrac_index(wavelength)  # should be cached when the same wavelengths are used
