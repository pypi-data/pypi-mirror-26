...
setup(
    name='clinical_research_study_manager',
    ...
    url='https://github.com/SethPitts/clinical_research_study_manager',

    # Author details
    author='Seth Pitts',
    author_email='sethpitts22@gmail.com',
    ...
    keywords='clinical research data management',
    ...
    install_requires=['pandas', 'openpyxl', 'numpy', 'matplotlib', 'xlrd'],
