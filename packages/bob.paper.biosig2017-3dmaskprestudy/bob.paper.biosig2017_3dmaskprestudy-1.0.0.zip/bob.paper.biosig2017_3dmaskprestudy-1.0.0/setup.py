...
setup(
    ...
    name='bob.paper.biosig2017_3dmaskprestudy',
    version=open("version.txt").read().rstrip(),
    description='Package for BioSIG-2017 paper on Extended-Range imaging for 3D-Mask PAD.',

    url='https://gitlab.idiap.ch/bob/bob.paper.biosig2017_3dmaskprestudy',
    license='GPLv3',
    author='Sushil Bhattacharjee',
    author_email='sushil.bhattacharjee@idiap.ch',
    keywords="Package for BioSIG-2017 paper on Extended-Range imaging for 3D-Mask PAD",
    ...
    entry_points={
        'console_scripts': [
            'thermal_mean_hist.py  =bob.paper.biosig2017_3dmaskprestudy.scripts.thermal_mean_hist:main',
        ],
    },
