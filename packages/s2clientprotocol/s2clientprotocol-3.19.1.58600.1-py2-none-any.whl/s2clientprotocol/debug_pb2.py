...
_DEBUGCOMMAND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='chat', full_name='SC2APIProtocol.DebugCommand.chat', index=8,
...
_DEBUGCHAT = _descriptor.Descriptor(
  name='DebugChat',
  full_name='SC2APIProtocol.DebugChat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='SC2APIProtocol.DebugChat.message', index=0,
