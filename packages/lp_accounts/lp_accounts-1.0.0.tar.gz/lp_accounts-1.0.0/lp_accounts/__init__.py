...
# Configure Account Serializers
settings.LP_ACCOUNTS_SERIALIZERS = {}
...
settings.LP_ACCOUNTS_GITHUB_KEY = getattr(
    settings, 'LP_ACCOUNTS_GITHUB_KEY', None)
settings.LP_ACCOUNTS_GITHUB_SECRET = getattr(
    settings, 'LP_ACCOUNTS_GITHUB_SECRET', None)
