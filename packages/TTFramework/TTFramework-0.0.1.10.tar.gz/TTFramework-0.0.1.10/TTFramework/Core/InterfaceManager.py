...
from .InterfaceBase import APIResponse,create_response
...
class IntefaceManager(Base):
    ...
    def __init__(self,router,configer,logger,japronto,statistics,service_manager):
        ...
        self.__japronto.extend_request(self.session, property=True)
        self.__japronto.add_error_handler(RouteNotFoundException, handle_not_found)
