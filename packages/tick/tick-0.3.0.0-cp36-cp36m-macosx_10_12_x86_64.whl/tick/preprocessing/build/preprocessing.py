...
def SparseLongitudinalFeaturesProductDeserialize(ptr: 'SparseLongitudinalFeaturesProduct', data: 'std::string const &') -> "void":
    """SparseLongitudinalFeaturesProductDeserialize(SparseLongitudinalFeaturesProduct ptr, std::string const & data)"""
    return _preprocessing.SparseLongitudinalFeaturesProductDeserialize(ptr, data)
...
class LongitudinalFeaturesLagger(object):
    ...
    def __init__(self, features: 'SBaseArrayDouble2dPtrList1D const &', n_lags: 'ulong const'):
        """__init__(LongitudinalFeaturesLagger self, SBaseArrayDouble2dPtrList1D const & features, ulong const n_lags) -> LongitudinalFeaturesLagger"""
...
def LongitudinalFeaturesLaggerDeserialize(ptr: 'LongitudinalFeaturesLagger', data: 'std::string const &') -> "void":
    """LongitudinalFeaturesLaggerDeserialize(LongitudinalFeaturesLagger ptr, std::string const & data)"""
    return _preprocessing.LongitudinalFeaturesLaggerDeserialize(ptr, data)
