...
class SVRG(StoSolver):
    ...
    def __init__(self, *args):
        """
        __init__(SVRG self, unsigned long epoch_size, double tol, RandType rand_type, double step, int seed, int threads=1, SVRG::VarianceReductionMethod variance_reduction) -> SVRG
        __init__(SVRG self, unsigned long epoch_size, double tol, RandType rand_type, double step, int seed, int threads=1) -> SVRG
