...
def TimeFunctionDeserialize(ptr: 'TimeFunction', data: 'std::string const &') -> "void":
    """TimeFunctionDeserialize(TimeFunction ptr, std::string const & data)"""
    return _base.TimeFunctionDeserialize(ptr, data)
