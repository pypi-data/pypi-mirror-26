...
setup(
    ...
    description='Some code that supposedly extracts zip/tar archives safely.',
    ...
    package_data={
        'safe_extractor': ['../README.md', '../VERSION', '../requirements.txt'], # TODO: Separate out the ui from the framework
    },
