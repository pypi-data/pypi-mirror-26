	...
	for item in filelist:
		...
		if groupname != '':
			...
			fileref.write(u'\t\t<' + compilername + ' Include="' + \
				burger.converttowindowsslashes(item.filename) + '">\n')
...
class Defaults(object):
	...
	def defaults(self, solution):
		...
		if solution.ide == makeprojects.core.IDETypes.vs2003:
			self.fileversion = FileVersions.vs2003

		elif solution.ide == makeprojects.core.IDETypes.vs2005:
			self.fileversion = FileVersions.vs2005

		elif solution.ide == makeprojects.core.IDETypes.vs2008:
			self.fileversion = FileVersions.vs2008

		elif solution.ide == makeprojects.core.IDETypes.vs2010:
			self.fileversion = FileVersions.vs2010

		elif solution.ide == makeprojects.core.IDETypes.vs2012:
			self.fileversion = FileVersions.vs2012

		elif solution.ide == makeprojects.core.IDETypes.vs2013:
			self.fileversion = FileVersions.vs2013

		elif solution.ide == makeprojects.core.IDETypes.vs2015:
			self.fileversion = FileVersions.vs2015

		elif solution.ide == makeprojects.core.IDETypes.vs2017:
		...
		self.acceptable = [makeprojects.core.FileTypes.h, makeprojects.core.FileTypes.cpp]
		if self.platformcode == 'win':
			self.acceptable.extend([makeprojects.core.FileTypes.rc, makeprojects.core.FileTypes.ico])
			# 2010 or higher supports hlsl and glsl files
			if self.fileversion.value >= FileVersions.vs2010.value:
				self.acceptable.extend([makeprojects.core.FileTypes.hlsl, makeprojects.core.FileTypes.glsl])

		# Xbox 360 shaders are supported
		elif self.platformcode == 'x36' and self.fileversion == FileVersions.vs2010:
			self.acceptable.append(makeprojects.core.FileTypes.x360sl)

		# PS Vita shaders are supported
		elif self.platformcode == 'vit' and self.fileversion == FileVersions.vs2010:
			self.acceptable.append(makeprojects.core.FileTypes.vitacg)
...
class vsProject(object):
	...
	def __init__(self, defaults, codefiles, includedirectories):
		...
		self.listh = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.h)
		self.listcpp = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.cpp)
		self.listwindowsresource = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.rc)
		self.listhlsl = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.hlsl)
		self.listglsl = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.glsl)
		self.listx360sl = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.x360sl)
		self.listvitacg = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.vitacg)
		self.listico = makeprojects.core.pickfromfilelist(codefiles, makeprojects.core.FileTypes.ico)
	...
	def writeproject2010(self, fp, solution):
		...
		elif solution.projecttype == makeprojects.core.ProjectTypes.tool:
			...
			if self.includedirectories or \
				...
				if self.includedirectories or linkerdirectories:
					...
					for item in self.includedirectories:
						fp.write(u'$(ProjectDir)' + burger.converttowindowsslashes(item) + ';')
...
def generate(solution, ide, perforce=False, verbose=False):
	...
	if ide == makeprojects.core.IDETypes.vs2003 or \
		ide == makeprojects.core.IDETypes.vs2005 or \
		ide == makeprojects.core.IDETypes.vs2008:
