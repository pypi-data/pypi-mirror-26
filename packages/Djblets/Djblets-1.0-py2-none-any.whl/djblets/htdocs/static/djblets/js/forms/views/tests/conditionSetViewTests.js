...
suite('djblets/forms/views/ConditionValueFormFieldView', function () {
    ...
    describe('Rendering', function () {
        it('Loaded rows', function () {
            ...
            expect($value.html()).toBe('<span><input type="text" name="my_conditions_value[0]">' + '</span>');
            ...
            expect($value.html()).toBe('<span><input type="email" name="my_conditions_value[1]">' + '</span>');
