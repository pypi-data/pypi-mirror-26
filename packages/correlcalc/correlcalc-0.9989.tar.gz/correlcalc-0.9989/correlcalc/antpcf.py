...
def atpcf(datfile, binspar, binsper, **kwargs):
    ...
    `correl3d, poserr=atpcf('/path/to/datfile.dat',bins, randfile='/path/to/randomfile.dat', vtype='sigpi', weights=True)`
    ...
    `correl3d, poserr=atpcf('/path/to/datfile.dat', bins, maskfile='/path/to/maskfile.ply', vtype='smu', weights='eq', randfact=3)`
