...
(function(d) {
    ...
    d.widget("ech.multiselect", {
        ...
        _create: function() {
            ...
            (this.headerLinkContainer = d("<ul />")).addClass("list-inline").html(function() {
                return !0 === b.header ? '<li style="float:left"><a class="ui-multiselect-all" href="#"><span class="fa fa-check-square-o" title="CkecKAll"></span><span>' + b.checkAllText + '</span></a></li><li style="float:left"><a class="ui-multiselect-none" href="#"><span class="fa fa-square-o" title="UncheckAll"></span><span>' + b.uncheckAllText + "</span></a></li>" : "string" === typeof b.header ? "<li>" + b.header + "</li>" : ""
            }).append('<li class="ui-multiselect-close"><a href="#" class="ui-multiselect-close"><span title="Close">Aplicar</span></a></li>').appendTo(c);
        ...
        refresh: function(a) {
            ...
            b.find("option").each(function(b) {
                ...
                e += '<li class="' + o + '">';
                e += '<label style="min-width:93%" for="' + b + '" title="' + h + '" class="' + m.join(" ") + '">';
                ...
                e += " /><span>" + f + "</span></label>"
                this.getAttribute('actions').split(' ').forEach(function(element){
                    button = z.getAttribute('button-'+element)
                    if (button != null){
                        e += button
                    }
                })
