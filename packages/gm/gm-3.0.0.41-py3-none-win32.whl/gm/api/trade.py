...
def order_volume(symbol, volume, side, order_type,
                 position_effect, price=0, order_duration=OrderDuration, order_qualifier=OrderQualifier_Unknown,account=''):
    """
    按指定量委托
    """
...
def order_target_volume(symbol, volume, position_side,
                        order_type, price=0, order_duration=OrderDuration,
...
def order_target_value(symbol, value, position_side,
                       order_type, price=0,
                       order_duration=OrderDuration, order_qualifier=OrderQualifier_Unknown,
                       account=''):
    """
    调仓到目标持仓额
    """
