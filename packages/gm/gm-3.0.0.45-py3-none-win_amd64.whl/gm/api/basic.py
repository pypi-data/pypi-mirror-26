...
from gm.enum import MODE_LIVE, ADJUST_NONE, MODE_BACKTEST
...
def run(strategy_id='', filename='', mode=MODE_LIVE, token='',
        backtest_start_time='',
        backtest_end_time='',
    ...
    if mode == MODE_BACKTEST:
        # context.start_time专门用来context.data初始化用, 如果不能用context.now 就得用它
