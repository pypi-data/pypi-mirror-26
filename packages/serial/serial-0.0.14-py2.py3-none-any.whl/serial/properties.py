...
class Null(object):
    ...
    def __repr__(self):
        return '%s()' % qualified_name(type(self))
...
class Property(object):
    ...
    def marshal(self, data):
        # type: (typing.Any) -> typing.Any
        return serial.model.marshal(data)  #, types=self.types, value_types=self.value_types)
...
class Array(Property):
    ...
    def unmarshal(self, data):
        # type: (typing.Any) -> typing.Any
        return serial.model.unmarshal(data, item_types=self.item_types)
