...
VALID_INFERENCE = ('viterbi', 'forward_backward', None)


class HMMLayer(Layer):
    def __init__(self, states, length=None, inference='viterbi', **kwargs):
        ...
        if inference not in VALID_INFERENCE:
            raise ValueError(('HMMLayer expected inference arguments to be {} found {}').format(
    ...
    def call(self, x):
        ...
        elif self.inference == 'forward_backward':
