...
description = "The insilicolynxdqi.calculations folder po_2c_total.py module"
...
class Po2CTotal:
	...
	def __str__(self):
		try:
			# Return output
			return "The insilicolynxdqi Po2CTotal class"
				...
				for row in reader:
					...
					for index in range(0, 5):
						...
						for dose in settings["doses"]:
							...
							# Calculate levels
							amountBVector, amountCVector, amountBCVector, t12Condition, t12Saturated, bt12Saturated, bt2, ct12Saturated, ct2, dosingParametersAUC = self.po2CTotal(doseTimes, timeVector, dose, vcentralList[index], k2Rates[index], k3Rates[index], k4Rates[index], alpha, beta, solubility6P5Saturated, fh, k1, t0, t1, t2, t3, t4)			
	...
	# Po 2C total levels
	def po2CTotal(self, doseTimes, timeVector, dose, v1, k2, k3, k4, alpha, beta, solubility6P5Saturated, fh, k1, t0, t1, t2, t3, t4):			  
		try:
			#
