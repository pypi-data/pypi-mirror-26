...
description = "The insilicolynxdqi.calculations folder po_1c_total.py module"
...
class Po1CTotal:
	...
	def __str__(self):
		try:
			# Return output
			return "The insilicolynxdqi Po1CTotal class"
			...
			with fileToRead:
				...
				for row in reader:
					...
					for dose in settings["doses"]:
						# Calculate levels
						amountBVector, t12Condition, t12Saturated, bt12Saturated, bt2, dosingParametersAUC = self.po1CTotal(doseTimes, timeVector, dose, vss, k4, solubility6P5Saturated, fh, k1, t0, t1, t2, t3, t4)
						...
						aucConcentrationBValues.update({dose:float(aucAmountB) / float(vss)})
	...
	# Po 1C total levels
	def po1CTotal(self, doseTimes, timeVector, dose, vss, k4, solubility6P5Saturated, fh, k1, t0, t1, t2, t3, t4):
		try:
			#
