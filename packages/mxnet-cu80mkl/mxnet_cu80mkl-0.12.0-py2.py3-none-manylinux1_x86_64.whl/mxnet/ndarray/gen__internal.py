...
def _CachedOp_NoGrad(out=None, name=None, **kwargs):
    r"""
...
def _crop_assign(lhs=None, rhs=None, begin=_Null, end=_Null, out=None, name=None, **kwargs):
...
def _crop_assign_scalar(data=None, scalar=_Null, begin=_Null, end=_Null, out=None, name=None, **kwargs):
...
def _slice_assign(lhs=None, rhs=None, begin=_Null, end=_Null, out=None, name=None, **kwargs):
    r"""Assign the rhs to a cropped subset of lhs.
