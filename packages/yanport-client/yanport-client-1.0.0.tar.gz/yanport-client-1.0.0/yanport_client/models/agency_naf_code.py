...
class AgencyNafCode(object):
    ...
    def __init__(self, id=None, label=None):
        """
        AgencyNafCode - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this AgencyNafCode.

        :return: The id of this AgencyNafCode.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this AgencyNafCode.

        :param id: The id of this AgencyNafCode.
        :type: str
        """
    ...
    def label(self):
        """
        Gets the label of this AgencyNafCode.

        :return: The label of this AgencyNafCode.
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """
        Sets the label of this AgencyNafCode.

        :param label: The label of this AgencyNafCode.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AgencyNafCode):
            return False
