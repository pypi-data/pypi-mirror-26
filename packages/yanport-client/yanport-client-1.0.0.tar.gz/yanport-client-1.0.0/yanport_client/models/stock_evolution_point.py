...
class StockEvolutionPoint(object):
    """
    ...
    def __init__(self, x=None, y=None):
        """
        StockEvolutionPoint - a model defined in Swagger
        """
    ...
    def x(self):
        """
        Gets the x of this StockEvolutionPoint.

        :return: The x of this StockEvolutionPoint.
        :rtype: date
        """
        return self._x
    ...
    def x(self, x):
        """
        Sets the x of this StockEvolutionPoint.

        :param x: The x of this StockEvolutionPoint.
        :type: date
        """
    ...
    def y(self):
        """
        Gets the y of this StockEvolutionPoint.

        :return: The y of this StockEvolutionPoint.
        :rtype: int
        """
        return self._y
    ...
    def y(self, y):
        """
        Sets the y of this StockEvolutionPoint.

        :param y: The y of this StockEvolutionPoint.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, StockEvolutionPoint):
            return False
