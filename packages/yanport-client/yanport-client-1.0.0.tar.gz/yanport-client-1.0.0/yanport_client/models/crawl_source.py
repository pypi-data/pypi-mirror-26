...
class CrawlSource(object):
    ...
    ANNONCES_JAUNES = "ANNONCES_JAUNES"
    PARU_VENDU = "PARU_VENDU"
    SE_LOGER = "SE_LOGER"
    TOP_ANNONCES = "TOP_ANNONCES"
    PAP = "PAP"
    IMMONOT = "IMMONOT"
    BELLES_DEMEURES = "BELLES_DEMEURES"
    PROPRIETES_DE_FRANCE = "PROPRIETES_DE_FRANCE"
    LUX_RESIDENCE = "LUX_RESIDENCE"
    BIEN_ICI = "BIEN_ICI"
    A_VENDRE_A_LOUER = "A_VENDRE_A_LOUER"
    ...
    def __init__(self):
        """
        CrawlSource - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CrawlSource):
            return False
