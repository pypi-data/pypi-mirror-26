...
class DateHistogram(object):
    ...
    """
    swagger_types = {
        'points': 'list[DateHistogramPoint]'
    }
    ...
    def __init__(self, points=None):
        """
        DateHistogram - a model defined in Swagger
        """
    ...
    def points(self):
        """
        Gets the points of this DateHistogram.

        :return: The points of this DateHistogram.
        :rtype: list[DateHistogramPoint]
        """
        return self._points
    ...
    def points(self, points):
        """
        Sets the points of this DateHistogram.

        :param points: The points of this DateHistogram.
        :type: list[DateHistogramPoint]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DateHistogram):
            return False
