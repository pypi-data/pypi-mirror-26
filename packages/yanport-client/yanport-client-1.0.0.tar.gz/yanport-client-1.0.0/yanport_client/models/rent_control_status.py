...
class RentControlStatus(object):
    """
    ...
    QUARTER_CONFLICT = "QUARTER_CONFLICT"
    ZONE_NOT_FOUND = "ZONE_NOT_FOUND"
    NO_PRICE = "NO_PRICE"
    NO_CONSTRUCTION_PERIOD = "NO_CONSTRUCTION_PERIOD"
    CONSTRUCTION_PERIOD_CONFLICT = "CONSTRUCTION_PERIOD_CONFLICT"
    VALID = "VALID"
    UNDER_MIN_PRICE_M2 = "UNDER_MIN_PRICE_M2"
    OVER_MAX_PRICE_M2 = "OVER_MAX_PRICE_M2"
    ...
    def __init__(self):
        """
        RentControlStatus - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RentControlStatus):
            return False
