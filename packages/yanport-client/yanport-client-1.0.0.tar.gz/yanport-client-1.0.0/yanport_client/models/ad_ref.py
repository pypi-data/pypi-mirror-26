...
class AdRef(object):
    ...
    def __init__(self, id=None, crawl_source=None, url=None):
        """
        AdRef - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this AdRef.

        :return: The id of this AdRef.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this AdRef.

        :param id: The id of this AdRef.
        :type: str
        """
    ...
    def crawl_source(self):
        """
        Gets the crawl_source of this AdRef.

        :return: The crawl_source of this AdRef.
        :rtype: CrawlSource
        """
    ...
    def crawl_source(self, crawl_source):
        """
        Sets the crawl_source of this AdRef.

        :param crawl_source: The crawl_source of this AdRef.
        :type: CrawlSource
        """
    ...
    def url(self):
        """
        Gets the url of this AdRef.

        :return: The url of this AdRef.
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        """
        Sets the url of this AdRef.

        :param url: The url of this AdRef.
        :type: str
        """
