...
|Join the chat at https://gitter.im/asciidots/Lobby|
...
News <https://news.ycombinator.com/item?id=14947449>`__

|AsciiDots being run in debug mode|

**`Try it online (debugger) <https://aaronduino.github.io/asciidots/demo>`__**
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

**`Try it online (tio.run) <https://tio.run/#asciidots>`__**
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
`Quine <https://en.wikipedia.org/wiki/Quine_(computing)>`__:
...
The interpreter for this language is the ``__main__.py`` file. It
...
| Yes this is very confusing (see `open issue about name change
  suggestions <https://github.com/aaronduino/asciidots/issues/18>`__).
...
`newline <https://en.wikipedia.org/wiki/Newline>`__.     When not in
...
.. |Join the chat at https://gitter.im/asciidots/Lobby| image:: https://badges.gitter.im/asciidots/Lobby.svg
   :target: https://gitter.im/asciidots/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge
.. |codebeat badge| image:: https://codebeat.co/badges/7351eeca-cc97-4fb2-9e18-fe3a00217f22
   :target: https://codebeat.co/projects/github-com-aaronduino-asciidots-master
.. |AsciiDots being run in debug mode| image:: https://github.com/aaronduino/asciidots/raw/master/dots_debug.gif
   :target: http://aaronduino.github.io/asciidots/demo.html?code=%20%20%20%20%2F1%23-.%0A%20%20%20%20%7C%0A%20%20%2F-%2B-%24%23%5C%0A%20%20%7C%20%7C%20%20%20%7C%0A%20%5B%2B%5D%3C1%23-*%0A%20%20%7C%20%20%20%20%20%7C%0A%20%20%5C--%3C--%2F%0A%20%20%20%20%20%7C%0A%20%20%20%20%200%0A%20%20%20%20%20%23%0A%20%20%20%20%20%7C%0A%20%20%20%20%20.%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20
