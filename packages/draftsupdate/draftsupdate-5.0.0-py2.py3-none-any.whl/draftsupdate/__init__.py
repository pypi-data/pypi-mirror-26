...
def main():
    ...
    parser.add_argument('--user', required=False, dest='user', help="the aws user from your ~/.aws/credentials")
    ...
    metadata = {'end_time': month_ago_string, 'start_time': month_minus_hour_string}
    ...
    results['spot_instance_data'] = spot_instance_data
    ...
    try:
        success = draftsutils.post_server(url_base, '/update_mapping', results, jwt)
