""" Configuration for calculating Hamming distances on fingervein features extracted using the Wide Line Detector feature extractor, for the UTFVP database """ 
