""" Configuration for calculating Hamming distances on fingervein features extracted using the Repeated Line Tracking feature extractor, for the UTFVP database """ 
...
temp_directory = './results/utfvp'  # pre-processed and extracted features will be placed here, along with the enrolled models  
sub_directory = 'rlt'
