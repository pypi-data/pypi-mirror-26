...
class NodeRun(Updateable, Serializable):
    """
    ...
    def __init__(self, node, parent):
        ...
        :type node: :py:class:`Tool <fastr.core.node.NodeRun>`
        ...
        self._required_cores = node.required_cores
        self._required_memory = node.required_memory
        self._required_time = node.required_time
    ...
    def dimnames(self, value):
        ...
        fastr.log.warning('You are overriding the dimnames of a NodeRun, beware this is possible but not encouraged and can lead to strange results!')
    ...
    def required_memory(self):
        """
        Amount of memory required for the execution of this NodeRun. Follows
    ...
    def required_time(self):
        """
        Amount of time required for the execution of this NodeRun. Follows the
    ...
    def execute(self):
        ...
        fastr.log.info('Generating jobs for node "{}" with dimensions: {}'.format(
            self.id,
    ...
    def create_job(self, sample_id, sample_index, job_data,
        ...
        """
        fastr.log.info('Creating job for node {} sample id {!r}, index {!r}'.format(self.global_id, sample_id, sample_index))
