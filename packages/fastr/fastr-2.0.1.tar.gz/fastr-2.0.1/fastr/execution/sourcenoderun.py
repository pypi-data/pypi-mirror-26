...
from fastr.execution.flownoderun import FlowNodeRun
from fastr.execution.inputoutputrun import SourceOutputRun
from fastr.execution.job import SourceJob, JobState
...
class SourceNodeRun(FlowNodeRun):
    ...
    def _wrap_arguments(self, job_data, sample_id, sample_index):
        ...
        """
        fastr.log.debug('Wrapping SourceNodeRun with {}'.format(job_data))
...
node_run_mapping['SourceNode'] = SourceNodeRun
node_run_mapping['ConstantNode'] = ConstantNodeRun
