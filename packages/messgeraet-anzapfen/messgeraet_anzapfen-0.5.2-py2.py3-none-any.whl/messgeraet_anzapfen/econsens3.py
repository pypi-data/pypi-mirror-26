...
class EconSens3(Sensor):
    ...
    def parse(self):
        ...
        data = EconSense3.parse_table_type_1(tables[0])
        data.update(EconSense3.parse_table_type_2(tables[1]))

        data2 = EconSense3.parse_table_type_1(tables[2])
        for key in data2:
