...
class ACView(View):
    ...
    def handle_auth_succeed(cls, request, auth_ctx, user):
        ...
        if options:
            return cls.render_kick_session_form(request, options,
        ...
        return cls.render_result_view(request, message, session_key)
    ...
    @classmethod
    def render_kick_session_form(cls, request, options, message):
        """ 踢出多余的客户端 """
