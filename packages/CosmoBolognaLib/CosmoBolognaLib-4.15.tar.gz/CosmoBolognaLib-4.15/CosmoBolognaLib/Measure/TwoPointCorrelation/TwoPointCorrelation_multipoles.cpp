...
vector<double> cosmobl::measure::twopt::TwoPointCorrelation_multipoles::xiHexadecapole () const
{
  vector<double> vv; 
  m_dataset->data(vv);
...
vector<double> cosmobl::measure::twopt::TwoPointCorrelation_multipoles::errorHexadecapole () const 
{
  vector<double> vv; 
  m_dataset->error(vv);
