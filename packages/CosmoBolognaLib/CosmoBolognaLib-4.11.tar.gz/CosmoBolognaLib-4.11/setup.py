...
class InstallClass (install):
    ...
    def run (self):
        ...
        os.system("mv Python/CosmoBolognaLib/__init__.py CosmoBolognaLib/")
        os.system("cp Python/CosmoBolognaLib/CosmoBolognaLib.py CosmoBolognaLib/")
        os.system("cp Python/CosmoBolognaLib/_CosmoBolognaLib.so CosmoBolognaLib/")
        os.chdir(cwd)
        install.run(self)
