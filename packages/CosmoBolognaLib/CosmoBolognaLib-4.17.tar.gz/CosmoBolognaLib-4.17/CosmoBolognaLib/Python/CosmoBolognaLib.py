...
def spherical_harmonics(l, m, xx, yy, zz):
    return _CosmoBolognaLib.spherical_harmonics(l, m, xx, yy, zz)
...
class Cosmology(_object):
    ...
    def zeta_covariance(self, Volume, nObjects, theta, r1, r2, kk, Pk, norders=10, prec=1.e-3):
        return _CosmoBolognaLib.Cosmology_zeta_covariance(self, Volume, nObjects, theta, r1, r2, kk, Pk, norders, prec)
...
class Pair1D_comoving_multipoles_lin(Pair1D_comoving):
    __swig_setmethods__ = {}
    for _s in [Pair1D_comoving]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
...
class Pair1D_comoving_multipoles_log(Pair1D_comoving):
    __swig_setmethods__ = {}
    for _s in [Pair1D_comoving]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
