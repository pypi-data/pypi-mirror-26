...
from ingredients_http.errors.validation import PayloadValidationError, ResponseValidationError


def model_in(cls, wrapper=None):
...
def model_out_pagination(cls=None):
    def model_handler(*args, **kwargs):
        ...
        list_name = cherrypy.serving.request.path_info.split("/")[2]
        data = {
            list_name: []
        }
