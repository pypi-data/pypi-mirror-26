...
class ESI:
    ...
    def __init__(self, base=None, endpoint=None, method=None, version=None, scopes=None, blocking=True, character=None,
        ...
        if base:
            ...
            self._datasource = base.datasource
            self._method = method or base.method
            self._scopes = scopes or base.scopes
            self._headers = base.headers
            self._blocking = base.blocking
            self._character = base.character

            self._access_token = base.access_token
            self._refresh_token = base.refresh_token
