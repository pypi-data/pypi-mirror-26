...
from typing import List, cast, Any, Dict, Iterator, Optional
...
# UModule = Union[ ModuleType, str ]
UModule = Any


class PluginManager:
    """
    Loads the set of user-selectable executables
    """
    ...
    def register( self, plugin: object, module_ = None ):
        """
        Registers a plugin.
    ...
    def __register_module( self, module_: UModule ):
        """
    ...
    def __register_folder( self, docs, name ):
    ...
    @staticmethod
    def __module_name_and_docs( module_: UModule ):
