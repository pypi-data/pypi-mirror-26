...
class __Environment:
    ...
    def name( self, value: str ):
        ...
        self.__constants["APP_ABBREVIATION"] = self.abv_name
    ...
    def abv_name( self, value: Optional[str] ) -> None:
        ...
        self.__constants["APP_ABBREVIATION"] = self.__version
