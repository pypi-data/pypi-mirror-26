...
from intermake.engine.progress_reporter import ProgressReporter, ActionHandler, TText, IProgressReceiver
...
class Mandate:
    ...
    def question( self, message: str, options: Sequence[object] = (True, False) ):
        """
