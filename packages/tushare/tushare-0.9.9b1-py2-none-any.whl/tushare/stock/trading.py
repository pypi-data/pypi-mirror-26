...
#     df = bar('01918', conn=apis, start_date='2016-08-01', end_date='', freq='d', asset='X')
    df = bar('600000', conn=apis, start_date='2011-08-01', end_date='', freq='m')
#     
#     df = get_instrument(xapi)

#     df = tick('000001', conn=apis)
