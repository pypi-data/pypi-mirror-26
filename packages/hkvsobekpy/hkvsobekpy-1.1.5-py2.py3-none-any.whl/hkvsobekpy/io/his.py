...
class __his_class(object):
    ...
    def KrijgLokaties(self):
        """
        Krijg de locations beschikbaar in de his-file. Vereiste is dat de LeesMetadata functie is uitgelezen
    ...
    def MultiWaardenArary(self, locations, parameters, startMMdd=(1,1), endMMdd=(12,31), 
