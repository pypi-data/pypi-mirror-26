...
:Parameters:
    ...
    weights: *optional*
        Specify the weights for the collapse. By default the collapse
        is unweighted. The weights are those that would be returned by
        this call of the field's `~cf.Field.weights` method:
        ``f.weights(weights, components=True)``. See
        `cf.Field.weights` for details.  By default *weights* is
        `None` meaning that the collapse is unweighted
