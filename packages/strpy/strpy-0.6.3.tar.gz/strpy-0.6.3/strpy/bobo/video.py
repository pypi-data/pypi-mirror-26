...
class Video(object):
    ...
    def __repr__(self):
        return str('<bobo.video: frames=%d>' % (len(self._framelist)))
...
class VideoCategory(Video):    
    ...
    def __repr__(self):
        return str('<bobo.videocategory: frames=%d, category="%s">' % (len(self), self._category))
...
class VideoDetection(VideoCategory):
    ...
    def __repr__(self):
        return str('<bobo.videodetection: frames=%d, category="%s">' % (len(self), str(self.category())))
