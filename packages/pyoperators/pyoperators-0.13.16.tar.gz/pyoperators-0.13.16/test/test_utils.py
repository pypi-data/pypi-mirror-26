...
from pyoperators.utils import (
    broadcast_shapes, cast, complex_dtype, deprecated, first, first_is_not,
    float_dtype, float_or_complex_dtype, ifirst, ifirst_is_not, ilast,
    ilast_is_not, groupbykey, inspect_special_values, interruptible,
    isscalarlike, last, last_is_not, least_greater_multiple,
    native_complex_dtype, native_float_dtype, one, omp_num_threads, pi,
    pool_threading, product, reshape_broadcast, setting, settingerr, split,
    strenum, strplural, strshape, Timer, uninterruptible, zero, zip_broadcast)
from pyoperators.utils.testing import (
    assert_eq, assert_not_in, assert_raises, assert_same)
from pyoperators.warnings import PyOperatorsDeprecationWarning

NEND = np.dtype(int).str[0]
OEND = '>' if NEND == '<' else '<'
DTYPES = (
    str, bool,
    ...
    OEND+'i1', OEND+'i2', OEND+'i4', OEND+'i8',
    OEND+'u1', OEND+'u2', OEND+'u4', OEND+'u8',
    OEND+'f2', OEND+'f4', OEND+'f8', #OEND+'f16',
    OEND+'c8', OEND+'c16') #OEND+'c32'
if hasattr(np, 'float128'):
    DTYPES = (DTYPES[:13] + (np.float128,) + DTYPES[13:15] + (np.complex256,) +
              DTYPES[15:-2] + (OEND+'f16',) + DTYPES[-2:] + (OEND+'c32',))


def _trim_float128(*args):
    l = list(args)
    if hasattr(np, 'float128'):
        return l
    for i in (-1, 28, 16, 13):
...
def test_complex_dtype():
    expecteds = _trim_float128(
        None, NEND+'c16',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c16', NEND+'c8', NEND+'c16', NEND+'c32',
        NEND+'c8',  NEND+'c16', NEND+'c32',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c16', NEND+'c8', NEND+'c16', NEND+'c32',
        NEND+'c8', NEND+'c16', NEND+'c32')
...
def test_native_complex_dtype():
    expecteds = _trim_float128(
        None, NEND+'c16',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c8', NEND+'c8', NEND+'c16', NEND+'c16',
        NEND+'c8',  NEND+'c16', NEND+'c16',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c16', NEND+'c16', NEND+'c16', NEND+'c16',
        NEND+'c8', NEND+'c8', NEND+'c16', NEND+'c16',
        NEND+'c8',  NEND+'c16', NEND+'c16')
    ...
    def func(dtype, expected):
        if expected is None:
            ...
            actual = native_complex_dtype(dtype)
            assert_eq(actual.str, expected)
    for dtype, expected in zip(DTYPES, expecteds):
        yield func, dtype, expected
...
def test_float_dtype():
    expecteds = _trim_float128(
        None, NEND+'f8',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f2', NEND+'f4', NEND+'f8', NEND+'f16',
        NEND+'f4',  NEND+'f8', NEND+'f16',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f2', NEND+'f4', NEND+'f8', NEND+'f16',
        NEND+'f4',  NEND+'f8', NEND+'f16')
...
def test_native_float_dtype():
    expecteds = _trim_float128(
        None, NEND+'f8',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f4', NEND+'f4', NEND+'f8', NEND+'f8',
        NEND+'f4',  NEND+'f8', NEND+'f8',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f8', NEND+'f8', NEND+'f8', NEND+'f8',
        NEND+'f4', NEND+'f4', NEND+'f8', NEND+'f8',
        NEND+'f4',  NEND+'f8', NEND+'f8')
    ...
    def func(dtype, expected):
        if expected is None:
            ...
            actual = native_float_dtype(dtype)
            assert_eq(actual.str, expected)
    for dtype, expected in zip(DTYPES, expecteds):
        yield func, dtype, expected
...
def test_inspect_special_values():
    dtypes = [
        np.dtype(t) for t in (np.bool8, np.uint8, np.int8, np.uint16,
        np.int16, np.uint32, np.int32, np.uint64, np.int64, np.float32,
        np.float64, np.complex64, np.complex128)]
    if hasattr(np, 'float128'):
        dtypes += [np.dtype(np.float128), np.dtype(np.complex256)]
...
def test_one_pi_zero():
    ...
    if hasattr(np, 'float128'):
        dtypemax = np.float128
        dtypes += (np.float128, np.complex256)
    else:
        dtypemax = np.float64
    expected = 1, 4 * np.arctan(np.array(1, dtypemax)), 0
