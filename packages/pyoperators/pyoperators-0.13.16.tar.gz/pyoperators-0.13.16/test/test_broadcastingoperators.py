...
clss = (ConstantOperator, DiagonalOperator,  HomothetyOperator,
        IdentityOperator, MaskOperator, ZeroOperator)
if numexpr is not None:
    clss += (DiagonalNumexprOperator,)
...
def test_partition():
    clss = (ConstantOperator, DiagonalOperator, HomothetyOperator,
            IdentityOperator, MaskOperator, PackOperator, UnpackOperator)
