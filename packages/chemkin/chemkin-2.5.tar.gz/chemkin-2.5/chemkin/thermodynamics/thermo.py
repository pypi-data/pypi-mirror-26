...
from chemkin import PATH_NASA_COEFF_DB

class Thermo():
    """ Class of thermodynamics.
    """

    def __init__ (self, species, T, ki, vi_p, vi_dp, db_path=PATH_NASA_COEFF_DB):
        self.p0 = 10e5
        self.R = 8.314
...
class ThermoDAO():
    """ Database Access Object for thermodynamics.
    """
