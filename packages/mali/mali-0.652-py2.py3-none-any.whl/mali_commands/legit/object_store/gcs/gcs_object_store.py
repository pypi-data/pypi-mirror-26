...
def __retry_operation(http_operation, on_failed):
...
class GCSDownload(GCSService):
    def download(self, bucket_name, object_name):
        ...
        __retry_operation(http_download, on_failed_download)
...
class GCSUpload(GCSService):
    def upload(self, bucket_name, object_name, body):
        ...
        __retry_operation(upload_method, on_failed_upload)
    ...
    def _get_request(self, bucket_name, object_name, body):
        ...
        url = self.signed_url_service.get_signed_urls('PUT', [object_name])[0]
