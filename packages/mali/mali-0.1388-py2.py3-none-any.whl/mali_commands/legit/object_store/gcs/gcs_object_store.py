...
class GCSObjectStore(ConnectionMixin, BaseObjectStore):
    ...
    def __init__(self, connection, use_multiprocess=True):
    ...
    def close(self):
        ...
        if self.is_multiprocess or self.__upload_pool is not None:
    ...
    def upload(self, obj, content_type=None, head_url=None, put_url=None):
        ...
        if self.is_multiprocess:
            ...
            self.__upload_pool.apply_async(
                ...
                callback=self.on_upload_result)
