...
class DatastoreRefContainer(ConnectionMixin, RefsContainer):
    ...
    def __build_key(self, datastore, name):
        ...
        parent_key = datastore.key('DataVolume', self._connection.data_volume_config.name, namespace=org_name)
