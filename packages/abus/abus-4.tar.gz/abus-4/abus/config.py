...
class Configuration(object):
      ...
      for line in lines:
         ...
         if not line or line.startswith('#'):
            ...
            if keyword=="archive":
               ...
               self.retention= parse_retention_args(args)
            else:
   ...
   def _get_command_line_options(self, argv):
      ...
      parser.add_argument('--reconstruct-location-index',
         action='store_true',
         help="""Reconstructs the location index, which stores the location of each
            backup file within the backup directory.""")
      parser.add_argument('--reconstruct',
         action='store_true',
         help="""Reconstructs the backup contents index, which stores the lists of files included in each backup run.
...
def parse_retention_args(arg_string):
   try:
