...
class TestRegex(TestCase):
    ...
    def test_decode(self, url):
        r = requests.get(url)
        print(r.encoding)
        print(str(r._content, "utf-8"))

    def test_decode_url(self):
        self.test_decode("http://spiderx.ks3-cn-beijing.ksyun.com/2017/09/http/money.qq.com/a/20170919/025636.htm")
        self.test_decode("http://spiderx.ks3-cn-beijing.ksyun.com/2017/09/https/www.baidu.com")
