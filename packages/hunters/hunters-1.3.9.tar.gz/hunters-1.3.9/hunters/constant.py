...
class Regex(Const):
    ...
    RE_CONTENT_TYPE_CHARSET = re.compile(r"""charset=(.*)""", re.I)
    ...
    RE_RAW_LINK = re.compile(r"""\.(png|gif|jpg|jpeg|doc|zip|rar|bin|gz|tar|docx|xls|xlsx|swf|woff|eot|ttf|svg)$""", re.I)
