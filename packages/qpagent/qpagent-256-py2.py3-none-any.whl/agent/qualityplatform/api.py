...
from agent.util.appetizerkit import AppToolKit, iOSToolKit
...
def register_agent(status):
    devices = []
    android_devices = AppToolKit().get_devices()
...
def add_results_for_cases(run_id, case_id, log, app=None):
    if app:
        comment = {
