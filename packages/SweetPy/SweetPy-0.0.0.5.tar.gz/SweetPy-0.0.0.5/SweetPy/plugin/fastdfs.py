...
from SweetPy.common.func_helper import FuncHelper

class FastDfsManager(object):
    is_save_instance = False
    def __init__(self,clientFile=''):
        self.__domainName = '' #'http://www.igap.cc/'
        self.__client_file = FuncHelper.get_file_path_by_full_path(__file__) + '/fastDfsClient.conf'
    ...
    def get_value_by_kwargs(self, **kwargs):
        return self
