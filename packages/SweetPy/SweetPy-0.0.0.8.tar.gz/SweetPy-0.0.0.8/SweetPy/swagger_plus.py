...
swagger_regex = RegexURLPattern('^swagger/$',schema_view)
...
rest_framework_swagger.renderers.OpenAPIRenderer = OpenAPIRenderer
# urlpatterns = [
#     # url(r'^$', schema_view),
#     RegexURLResolver(r'^/swagger/$',schema_view,app_name= 'rest_framework_swagger')
# ]