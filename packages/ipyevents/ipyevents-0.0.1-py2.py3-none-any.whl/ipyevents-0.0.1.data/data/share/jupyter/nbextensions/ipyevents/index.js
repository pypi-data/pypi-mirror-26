...
var EventModel = (function (_super) {
    ...
    EventModel.prototype.remove_listeners = function () {
        ...
        for (var _i = 0, _a = this.get('_attached_listeners'); _i < _a.length; _i++) {
            var listener = _a[_i];
    ...
    EventModel.prototype._dom_click = function (generating_view, event) {
        ...
        if ('_array_xy' in generating_view) {
            var array_coords = generating_view['_array_xy'](event);
            ...
            // view.
            var array_coords = _click_location_original_image(generating_view, event);
            event['arrayX'] = array_coords.x;
            event['arrayY'] = array_coords.y;
        }
...
module.exports = {"name":"ipyevents","version":"1.0.0","description":"A custom widget for returning mouse and keyboard events to Python","author":"Matt Craig","license":"BSD-3-Clause","main":"lib/index.js","repository":{"type":"git","url":"https://github.com/mwcraig/ipyevents.git"},"keywords":["jupyter","widgets","ipython","ipywidgets"],"files":["lib/**/*.d.ts","lib/**/*.js","dist/*.js"],"scripts":{"clean":"rimraf dist/ & rimraf lib/","prepublish":"npm run clean && npm run build && webpack","test":"echo \"Error: no test specified\" && exit 1","build:src":"tsc --project src","build":"npm run build:src"},"devDependencies":{"webpack":"^3.5.5","rimraf":"^2.6.1","typescript":"~2.4.1","@types/node":"^8.0.1"},"dependencies":{"@jupyter-widgets/base":"^1.0.4","@jupyter-widgets/controls":"^1.0.5","lodash":"^4.17.4"}}
