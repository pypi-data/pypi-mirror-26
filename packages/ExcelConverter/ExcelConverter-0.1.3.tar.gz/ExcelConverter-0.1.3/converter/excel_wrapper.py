        ...
        if not self.values:
            ...
            for row in self.cellsDO:
                ...
                for cell in row:
                    ...
                    elif cell.data_type == 'e' and cell.value and cell.value == '#N/A':
                        # We have to set None, such that it will be evaluated when one of it's dependencies changes it's
                        # value that has a None as original value, as this change will not result in a reset of this cell
                        # (see the reset in SpreadSheet.setValue())
                        col += (None,)
