...
@catch_jira_errors
def lookup(verbose, search_aliases):
    """
    ...
    *IMPORTANT NOTE*
    ...
    For this application of lookup it makes sense that you create another
    search alias which is responsible for ordering:
