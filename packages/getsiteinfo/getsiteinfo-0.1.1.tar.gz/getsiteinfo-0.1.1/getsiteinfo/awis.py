...
The original version was in Python 2, couldn't work with Python 3,
Kay Wang converted it to Python 3.
...
class AwisApi(object):
    ...
    def sign(self, params):
        ...
        hmac_signature = hmac.new(bytearray(self.secret_access_key, 'ASCII'), bytearray(msg, 'ASCII'), hashlib.sha1)
