...
from trosnoth.const import MOVEMENT_RETRO, MOVEMENT_NORMAL
...
class PhysicsConstants(object):
    ...
    def _standard(self, pace=1, fireRate=1, gravity=1, jumpHeight=1,
            ...
            normal=False, movement=MOVEMENT_RETRO, playerDampingFactor=0.3):
        ...
        self.playerRunAcceleration = 720 * pace       # pix/s/s
        self.playerRunDeceleration = 4000 * pace      # pix/s/s
        self.playerMaxRunSpeed = 720 * pace          # pix/s
    ...
    def setModeRetro(self):
        self._standard(movement=MOVEMENT_RETRO)

    def setModeMomentum(self):
        self._standard(movement=MOVEMENT_NORMAL)
