...
class MediaCloud(object):
    ...
    def storyRawCliffResults(story_id_list):
        return self._queryForJson(self.V2_API_URL+'stories/cliff', { 'stories_id': story_ids })

    def storyRawNytThemeResults(story_id_list):
        return self._queryForJson(self.V2_API_URL+'stories/nytlabls', { 'stories_id': story_ids })        
