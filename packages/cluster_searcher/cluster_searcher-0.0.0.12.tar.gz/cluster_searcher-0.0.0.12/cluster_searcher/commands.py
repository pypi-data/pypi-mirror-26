...
class BlastLine:
    def __init__( self, line, warn_blast_line: ByRef[bool] ) -> None:
        ...
        self.leca_gene = _leca_file.lookup_by_leca.get( self.subject_id ) if _leca_file else None
...
class KeggFile:
    ...
    def __init__( self, file_name: str, naming: EKeggNaming, permit: List[str] ) -> None:
        """
        CONSTRUCTOR 
        """
...
def find_blast_confidences( gene: KeggGene ) -> Dict[str, int]:
    ...
    blast_lines = _blast_file.lookup_by_kegg.get( gene.gene_id )
