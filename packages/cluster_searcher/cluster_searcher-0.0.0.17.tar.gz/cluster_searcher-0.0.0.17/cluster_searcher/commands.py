...
COLOURS_BLAST = { EBlastConfidence.NO_MATCH: (colours.BLACK, colours.ORANGE),
                  ...
                  EBlastConfidence.MULTIPLE: (colours.BLACK, colours.SPRING_GREEN) }
"""Colours of the confidence levels"""
...
COLOURS_COMBINED = { (EConfidence.NAME_EXACT, EBlastConfidence.NO_MATCH)    : (colours.ORANGE, colours.GREEN),
                     ...
                     (EConfidence.NAME_EXACT, EBlastConfidence.MULTIPLE)    : (colours.SPRING_GREEN, colours.GREEN),
                     ...
                     (EConfidence.NAME_NUMERIC, EBlastConfidence.MULTIPLE)  : (colours.SPRING_GREEN, colours.YELLOW),
                     ...
                     (EConfidence.USER_FOUND, EBlastConfidence.MULTIPLE)    : (colours.SPRING_GREEN, colours.DARK_GREEN),
                     ...
                     (EConfidence.USER_NOT_FOUND, EBlastConfidence.MULTIPLE): (colours.SPRING_GREEN, colours.DARK_RED),
                     ...
                     (EConfidence.USER_AMBIGUOUS, EBlastConfidence.MULTIPLE): (colours.SPRING_GREEN, colours.DARK_BLUE),
                     ...
                     (EConfidence.USER_DOMAIN, EBlastConfidence.MULTIPLE)   : (colours.SPRING_GREEN, colours.DARK_CYAN),
                     ...
                     (EConfidence.TEXT_CONTAINS, EBlastConfidence.MULTIPLE) : (colours.SPRING_GREEN, colours.BLUE),
                     ...
                     (EConfidence.ERROR, EBlastConfidence.MULTIPLE)         : (colours.SPRING_GREEN, colours.GRAY),
                     ...
                     (EConfidence.NO_MATCH, EBlastConfidence.MULTIPLE)      : (colours.SPRING_GREEN, colours.RED) }
...
@command()
def load_kegg( file_name: Filename[__EXT_KEGG], permit: Optional[List[str]] = None, verbose: bool = False ):
    """
...
@command()
def translate( colour: EResolveColour, read: MOptional[Filename[__EXT_REPORT]] = None, write: MOptional[Filename[__EXT_UDM]] = None ):
    """
