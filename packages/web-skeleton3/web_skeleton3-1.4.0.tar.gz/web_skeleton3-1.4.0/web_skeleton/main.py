...
comandos = ['init', 'skeleton', 'render', 'link', 'rsync']
...
"rsync ==> syncronize the tag version with the remote host.\n"
    ...
    def skeleton(self):
        ...
        print("Next steps:")
        print("   - Create new js/css/scss files in `code/app` directory")
        print("       - Use `web-skeleton3 link` command to link new files from 'code/app' to 'tag' directory")
