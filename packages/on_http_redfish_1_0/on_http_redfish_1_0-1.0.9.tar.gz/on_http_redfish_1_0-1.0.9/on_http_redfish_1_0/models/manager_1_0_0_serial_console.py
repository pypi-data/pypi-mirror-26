...
class Manager100SerialConsole(object):
    """
    ...
    def __init__(self):
        """
        Manager100SerialConsole - a model defined in Swagger
    ...
    def connect_types_supported(self):
        """
        Gets the connect_types_supported of this Manager100SerialConsole.
        This object is used to enumerate the Serial Console connection types allowed by the implementation.

        :return: The connect_types_supported of this Manager100SerialConsole.
        :rtype: list[str]
        """
    ...
    def connect_types_supported(self, connect_types_supported):
        """
        Sets the connect_types_supported of this Manager100SerialConsole.
        This object is used to enumerate the Serial Console connection types allowed by the implementation.

        :param connect_types_supported: The connect_types_supported of this Manager100SerialConsole.
        :type: list[str]
        """
    ...
    def max_concurrent_sessions(self):
        """
        Gets the max_concurrent_sessions of this Manager100SerialConsole.
        Indicates the maximum number of service sessions, regardless of protocol, this manager is able to support.

        :return: The max_concurrent_sessions of this Manager100SerialConsole.
        :rtype: float
        """
    ...
    def max_concurrent_sessions(self, max_concurrent_sessions):
        """
        Sets the max_concurrent_sessions of this Manager100SerialConsole.
        Indicates the maximum number of service sessions, regardless of protocol, this manager is able to support.

        :param max_concurrent_sessions: The max_concurrent_sessions of this Manager100SerialConsole.
        :type: float
        """
    ...
    def service_enabled(self):
        """
        Gets the service_enabled of this Manager100SerialConsole.
        Indicates if the service is enabled for this manager.

        :return: The service_enabled of this Manager100SerialConsole.
        :rtype: bool
        """
    ...
    def service_enabled(self, service_enabled):
        """
        Sets the service_enabled of this Manager100SerialConsole.
        Indicates if the service is enabled for this manager.

        :param service_enabled: The service_enabled of this Manager100SerialConsole.
        :type: bool
        """
