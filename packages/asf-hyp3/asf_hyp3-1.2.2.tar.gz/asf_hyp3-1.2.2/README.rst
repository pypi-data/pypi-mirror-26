...
:Parameters:
    ...
    Optional - id, sub_id, creation_date, start_date, end_date, name, group_id, format
...
must be passed as set's of sub_id's. If a sub_id appears in both sets, it is
ignored.

:Parameters:
    Required - id

    Optional - name, description, add_subs, rem_subs
