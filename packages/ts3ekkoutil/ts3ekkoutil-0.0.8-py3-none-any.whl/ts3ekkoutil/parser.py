...
def create_ekko_parser():
    ...
    add_env_option(parser, '--ts3-secrets-path', epn.TS3_SECRETS_PATH, '/root/.ts3client/ts3clientui_qt.secrets.conf')
    add_env_option(parser, '--ts3-secrets-old-identity', epn.TS3_SECRETS_OLD_IDENTITY)
