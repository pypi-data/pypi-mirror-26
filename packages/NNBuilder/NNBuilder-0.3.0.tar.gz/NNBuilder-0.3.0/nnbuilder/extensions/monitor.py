...
class ex(base):
    ...
    def init(self):
        ...
        if self.compare_repo is not None:
            if isinstance(self.compare_repo, (tuple, list)):
                for repo in self.compare_repo:
                    ...
                    if os.path.isfile(savefile):
                        self.compare_saving.append(load_date(savefile))
    ...
    def after_epoch(self):
        ...
        if self.plot:
            ...
            thread.start_new_thread(plotter.progress, (nnbuilder.config.name,
