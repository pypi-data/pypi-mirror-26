...
class DataOceanClient(RESTClient):
    ...
    def __init__(self, url, client_id, client_secret, crypt_key):
        ...
        self.req_data = {'req_data': '', 'client': self.client_id}

    def call_api(self, url, req_data, method='post'):
        ...
        return do_method(url, data=self.req_data)
