...
from metaparser.util import keynames_exist
from metaparser.util.schemaengine import Any, Optional
from metaparser.util.traceabledict import TraceableDict
...
class TestMetaparser(unittest.TestCase):
    ...
    def test_tracer(self):
        ...
        self.assertEqual(MetaParser.tracer, 
                         {'test_metaparser.ShowVersion': set()})
        
        # access keys
        output['hardware']['chassis']
        self.assertEqual(MetaParser.tracer,
                    {'test_metaparser.ShowVersion': {('hardware', 'chassis')}})
