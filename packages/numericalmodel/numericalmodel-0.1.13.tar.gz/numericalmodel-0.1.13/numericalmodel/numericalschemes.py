...
class SetOfNumericalSchemes(utils.SetOfObjects):
    ...
    def assert_plan_valid(self, plan):
        ...
        """
        self.logger.debug("### Testing the plan ###")
        ...
        for stage in plan: # go over each stage
            ...
            self.logger.debug( "{} needs the unified timesteps {}".format(
            ...
            for step in steps: # check data availability of each step
                ...
                for in_ivid in self[ivid].equation.input.keys():
                    ...
                    if in_ivid == ivid: # dependencies on itself 
                        ...
                        self.logger.debug("We do not simulate {} so we " 
            ...
            self.logger.debug("We successfully integrated {} to {}".format(
                ivid,steps))
        self.logger.debug("Final test simulation: {}".format(simulation))
        self.logger.debug("### Plan test was successfull ###")
        return True
