...
def get_id_and_name(header, converted_date, cursor, time_alignement_buffer=5):
...
def logfilenamer(filepath, cursors, skip_if_exists=True, time_alignement_buffer=5):
