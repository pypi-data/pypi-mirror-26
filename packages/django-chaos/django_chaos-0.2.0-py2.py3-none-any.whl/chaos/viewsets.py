...
class BaseProjectViewSet(viewsets.ModelViewSet):
    ...
    def clone(self, request, pk=None):
        ...
        try:
            ...
            logger.error('error while cloning project %s. error: %s', project, message)
...
class TaskViewSet(viewsets.ModelViewSet):
    ...
    def clone(self, request, pk=None):
        ...
        try:
            ...
            message = ex.message if hasattr(ex, 'message') else ''
            logger.error('failed to clone task %s. error: %s', task, message)
            return Responses.server_error(message)
    ...
    def change_status(self, request, pk=None):
        ...
        try:
            ...
            logger.error('something wrong happened while trying to change task status. %s', error_msg)
...
class AllocationViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        try:
            ...
            print(ex)
            message = ex.message if hasattr(ex, 'message') else ''
            logger.error('error while fetching list of allocations. Error: %s', message)
            return Responses.server_error(message)
    ...
    def retrieve(self, request, pk=None):
        ...
        try:
            ...
            message = ex.message if hasattr(ex, 'message') else ''
            logger.error('error while fetching allocation for user %s. Error: %s', user, message)
