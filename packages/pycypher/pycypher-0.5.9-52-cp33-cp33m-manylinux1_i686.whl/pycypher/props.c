...
void pycypher_init_props(void) {
  ...
  INIT_TABLE( pycypher_ast_list_plus_one_prop_t, pycypher_ast_list_plus_one_props, TABLE({
    { CYPHER_AST_COMPARISON, "arguments", "argument", cypher_ast_comparison_get_length, cypher_ast_comparison_get_argument, },
  }))
