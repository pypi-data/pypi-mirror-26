...
# Disabled, as it's basically the same as `SimplySupportedBeam`
# class BradfordType2SimplySupportedBeam(SimplySupportedBeam):
#     id = 11 #@ReservedAssignment


# class BradfordType2ClampedClampedBeam(ClampedClampedBeam):
#     id = 12 #@ReservedAssignment
#     characteristic_function = sin(mu_m)
#     
#     def mu_m_initial_guess(self, mode):
#         return mode * pi
#    
#     def Y_m(self, mode): #@UnusedVariable
#         return sin(mu_m*y/a) * sin(pi*y/a)
