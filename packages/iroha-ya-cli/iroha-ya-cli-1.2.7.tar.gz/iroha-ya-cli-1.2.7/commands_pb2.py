...
_GRANTPERMISSION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='permission_name', full_name='iroha.protocol.GrantPermission.permission_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REVOKEPERMISSION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='permission_name', full_name='iroha.protocol.RevokePermission.permission_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXTERNALGUARDIAN = _descriptor.Descriptor(
  name='ExternalGuardian',
  full_name='iroha.protocol.ExternalGuardian',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='account_id', full_name='iroha.protocol.ExternalGuardian.account_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='locked_asset_id', full_name='iroha.protocol.ExternalGuardian.locked_asset_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='unlocked_asset_id', full_name='iroha.protocol.ExternalGuardian.unlocked_asset_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='unit_amount', full_name='iroha.protocol.ExternalGuardian.unit_amount', index=3,
...
_COMMAND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='grant_permission', full_name='iroha.protocol.Command.grant_permission', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='revoke_permission', full_name='iroha.protocol.Command.revoke_permission', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_guardian', full_name='iroha.protocol.Command.external_guardian', index=14,
...
_EXTERNALGUARDIAN.fields_by_name['unit_amount'].message_type = primitive__pb2._AMOUNT
...
_COMMAND.fields_by_name['external_guardian'].message_type = _EXTERNALGUARDIAN
...
_COMMAND.oneofs_by_name['command'].fields.append(
  _COMMAND.fields_by_name['external_guardian'])
_COMMAND.fields_by_name['external_guardian'].containing_oneof = _COMMAND.oneofs_by_name['command']
...
DESCRIPTOR.message_types_by_name['ExternalGuardian'] = _EXTERNALGUARDIAN
...
ExternalGuardian = _reflection.GeneratedProtocolMessageType('ExternalGuardian', (_message.Message,), dict(
  DESCRIPTOR = _EXTERNALGUARDIAN,
  __module__ = 'commands_pb2'
  # @@protoc_insertion_point(class_scope:iroha.protocol.ExternalGuardian)
  ))
_sym_db.RegisterMessage(ExternalGuardian)
