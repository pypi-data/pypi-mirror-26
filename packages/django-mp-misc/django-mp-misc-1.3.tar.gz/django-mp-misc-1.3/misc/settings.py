...
class BowerSettingsMixin(object):
    ...
    def BOWER_COMPONENTS_ROOT(self):
        return os.path.join(self.PUBLIC_FILES_DIR, 'static')
...
class DjangoSettingsMixin(object):
    ...
    def STATIC_ROOT(self):
        return os.path.join(self.PUBLIC_FILES_DIR, 'static-collect')

    @property
    def MEDIA_ROOT(self):
        return os.path.join(self.PUBLIC_FILES_DIR, 'media')
