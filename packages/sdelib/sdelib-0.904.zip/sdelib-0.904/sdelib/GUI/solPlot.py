...
class Ui_solPlot(object):
    def setupUi(self, solPlot):
        ...
        self.btnStore = QtWidgets.QPushButton(solPlot)
        self.btnStore.setObjectName("btnStore")
        self.verticalLayout.addWidget(self.btnStore)

        self.retranslateUi(solPlot)
        QtCore.QMetaObject.connectSlotsByName(solPlot)
        solPlot.setTabOrder(self.btnPlot, self.btnStore)
    ...
    def retranslateUi(self, solPlot):
        ...
        self.btnStore.setText(_translate("solPlot", "Store problem realization (contains solution dictionary with solver names as keys)"))
