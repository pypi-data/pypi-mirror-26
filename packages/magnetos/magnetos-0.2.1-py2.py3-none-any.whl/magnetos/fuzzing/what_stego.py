...
class WhatStego(object):
    ...
    def get_flag_from_string(self, file_path, result_dict=None):
        ...
        if isinstance(data, bytes):
            data = self.bytes_2_printable_strings(data)
    ...
    def strings(self):
        ...
        self.file_2_printable_strings(self.file_path, out_file)
    ...
    @classmethod
    def bytes_2_printable_strings(cls, data):
    ...
    def file_2_printable_strings(self, file_name, output_file=None):
    ...
    def run(self):
        ...
        self.get_flag_from_string(zsteg_txt, find_flag_result_dict)
        strings_txt = os.path.join(self.output_path, 'strings_1.txt')
        self.get_flag_from_string(strings_txt, find_flag_result_dict)
        strings_txt = os.path.join(self.output_path, 'strings_2.txt')
        self.get_flag_from_string(strings_txt, find_flag_result_dict)
        self.log('=======================')
        self.log_file.close()
