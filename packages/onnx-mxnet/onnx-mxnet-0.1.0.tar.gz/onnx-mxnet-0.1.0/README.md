...
img_url = 'https://s3.amazonaws.com/onnx-mxnet/examples/cat.png'
...
result_img.save("super_res_cat.jpg")

```

Here's the input image and the resulting output images compared. As you can see, the model was able to increase the spatial resolution from 224x224 to 672x672.

| Input Image | Output Image |
| ----------- | ------------ |
| ![input](cat.jpg) | ![output](supercat.jpg) |
