...
class XDCCDownloaderTui(object):
    ...
    def __init__(self):
        ...
        self.gpl_notice = urwid.Text(
            u"XDCC Downloader V " + version + u"\n"
            u"Copyright (C) 2016-2017 Hermann Krumrey\n\n"
        ...
        self.server_edit = urwid.Edit(
            caption=u"Server: ", edit_text=u"irc.rizon.net")
        ...
        self.search_term_edit = urwid.Edit(
            caption=u"Search Term: ", edit_text=u"")
        ...
        self.destination_edit = urwid.Edit(
            caption=u"Destination Directory: ", edit_text=os.getcwdu())
    ...
    def connect_widgets(self):
        ...
        urwid.connect_signal(
            self.add_pack_button, u'click', self.add_pack_manually)
        urwid.connect_signal(self.search_button, u'click', self.search)
        urwid.connect_signal(
            self.add_search_result_button, u'click',
            self.add_selected_search_result_packs
        )
        urwid.connect_signal(
            self.remove_pack_button, u'click', self.remove_selected_packs)
    ...
    def search(self, button):
        ...
        if not self.searching:
            ...
            searcher = PackSearcher() if search_engine == u"All" \
        ...
        if not self.downloading:
            ...
            if not os.path.isdir(destination):
                ...
                self.show_message_popup(
                    u"The entered directory does not exist."
                )
                return
    ...
    def update_progress(self, single_precentage,
                        total_percentage):
        u"""
    ...
    def show_message_popup(self, message):
        ...
        # pragma: no cover
        urwid.connect_signal(button, u'click', lambda x: self.refresh_ui())
