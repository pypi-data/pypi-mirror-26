...
class UnitTests(unittest.TestCase):
    ...
    def test_searching(self):
        ...
        self.assertEqual(
            self.form.search_engine_combo_box.currentText(), u"namibsun")
    ...
    def test_adding_manual_pack(self):
        ...
        self.assertEqual(
            self.form.message_edit.text(), u"/msg xdcc_servbot xdcc send #1")
    ...
    def test_search_while_searching(self):
        ...
        self.assertEqual(
            self.form.search_engine_combo_box.currentText(), u"All")
    ...
    def test_spin_update(self):
        ...
        self.form.spinner_updater_signal.emit(
            self.form.download_button, u"NotDownload")
