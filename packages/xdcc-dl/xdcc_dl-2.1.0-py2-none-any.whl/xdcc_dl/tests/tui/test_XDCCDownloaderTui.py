...
class UnitTests(unittest.TestCase):
    ...
    def test_removing_packs_from_queue(self):
        self.tui.download_queue = xdcc_packs_from_xdcc_message(
            u"/msg xdcc_servbot xdcc send #1-3")
    ...
    def test_download(self):
        self.tui.download_queue = xdcc_packs_from_xdcc_message(
            u"/msg xdcc_servbot xdcc send #1-3", server=u"irc.namibsun.net")
        self.tui.refresh_ui()
    ...
    def test_download_while_downloading(self):
        ...
        self.tui.download_queue = xdcc_packs_from_xdcc_message(
            u"/msg Ginpachi-Sensei xdcc send #1")
        self.tui.refresh_ui()
        self.tui.download(None)
    ...
    def test_download_wrong_directory(self):
        ...
        self.assertEqual(
            self.tui.destination_edit.get_edit_text(), os.getcwdu())
