...
class UnitTests(unittest.TestCase):
    ...
    def test_gin_txt(self):
        packs = find_nibl_packs(u"AHQ Official Dragon Ball Z Releases.txt")
        ...
        self.assertEqual(pack.get_filename(),
                         u"AHQ Official Dragon Ball Z Releases.txt")
        self.assertEqual(pack.get_bot(), u"Arutha|DragonBall")
