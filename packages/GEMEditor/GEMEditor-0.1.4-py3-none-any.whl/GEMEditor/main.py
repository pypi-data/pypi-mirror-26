...
from GEMEditor.dialogs.qualitychecks import FailingEvidencesDialog, factory_duplicate_dialog
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def find_duplicate_metabolites(self):
        if self.model:
            duplicates = group_duplicate_reactions()
    ...
    def metanetx_update_mapping(self):
        ...
        with ProgressDialog(self, title="Update mapping..") as progress:
            get_metabolite_to_entry_mapping(self.model, progress)
