...
This module provides custom exception classes for GTXStorage library
...
class GTXStorageError(Exception):
    """
    ...
    def __init__(self, message, **kwargs):
        super(GTXStorageError, self).__init__(**kwargs)
...
class InvalidEndpointError(GTXStorageError):
    """
...
class InvalidBucketError(GTXStorageError):
    """
...
class InvalidArgumentError(GTXStorageError):
    """
...
class InvalidSizeError(GTXStorageError):
    """
...
class InvalidXMLError(GTXStorageError):
    """
...
class ResponseError(GTXStorageError):
    """
...
class KnownResponseError(GTXStorageError):
