...
# configuration
#---------------------------------------------------------------------------# 
setup(name  = 'ccatterina.pymodbus',
    version = __version__,
    description = 'A fully featured modbus protocol stack in python',
    long_description='''
    Fork of https://github.com/riptideio/pymodbus.
    ...
    author = __author__,
    author_email = 'ccatterina@energievalsabbia.it',
    maintainer = __author__,
    maintainer_email = 'ccatterina@energievalsabbia.it',
    url='https://github.com/ccatterina/pymodbus/',
    license = 'BSD',
