...
class Program:
    ...
    """
    def __init__(self, identifier, creator_id, name, version, description):
...
def parse_program(dictionary):
    ...
    res = Program(identifier, creator_id, name, version, description)
    return res
...
class Message:
    ...
    """
    def __init__(self, identifier, message_components, only_for_developers):
        self.identifier = identifier
...
def parse_message(dictionary):
    ...
    res = Message(identifier, message_components, only_for_developers)
    return res
...
class Option:
    ...
    """
    def __init__(self, identifier, description, trigger_rule, display, actions, existing_arguments, creator_id=None):
        self.identifier = identifier
        self.description = description
        self.trigger_rule = trigger_rule
...
def parse_option(dictionary):
    ...
    existing_arguments = dictionary['existing_arguments']
    creator_id = dictionary['creator_id']
    res = Option(identifier, description, trigger_rule, display, actions, existing_arguments, creator_id=creator_id)
    return res
...
class ObjectManager:
    ...
    def update_step_start(self, step_model):
        ...
        parameter_details = [('priority_of_asking_for_input', '_set_priority_of_asking_for_input', 'weight',),
                            ('priority_of_presenting_options', '_set_priority_of_presenting_options', 'weight',),
                            ('threshold_for_displaying_option', '_set_options_display_threshold', 'weight',),
                            ('threshold_for_executing_option', '_set_options_execution_threshold', 'weight',),
                            ('rule_eligibility_min_ratings_count', '_set_rule_eligibility_min_ratings_count', 'weight',),
                            ('rule_eligibility_inherit_rating', '_set_rule_eligibility_inherit_rating', 'boolean',),
                            ('rule_eligibility_requires_moderator_approval', '_set_rule_eligibility_requires_moderator_approval', 'boolean',),
                            ('rule_eligibility_always_allow_own_rules', '_set_rule_eligibility_always_allow_own_rules', 'boolean',),]
