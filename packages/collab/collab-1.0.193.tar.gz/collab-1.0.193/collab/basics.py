...
class Option:
    ...
    """
    def __init__(self, identifier, description, trigger_rule, display, actions, existing_arguments, trigger=None, creator_id=None):
        self.identifier = identifier
        self.description = description
        self.trigger_rule = trigger_rule
...
def parse_option(dictionary):
    ...
    trigger = dictionary['trigger']
    creator_id = dictionary['creator_id']
    res = Option(identifier, description, trigger_rule, display, actions, existing_arguments, trigger=trigger, creator_id=creator_id)
    return res
