...
typename __pythran_util_pythran::project_perpk3d::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,3>, pythonic::types::ndarray<double,3>, pythonic::types::ndarray<double,3>, pythonic::types::ndarray<double,3>>::result_type project_perpk3d0(pythonic::types::ndarray<std::complex<double>,3> a0, pythonic::types::ndarray<std::complex<double>,3> a1, pythonic::types::ndarray<std::complex<double>,3> a2, pythonic::types::ndarray<double,3> a3, pythonic::types::ndarray<double,3> a4, pythonic::types::ndarray<double,3> a5, pythonic::types::ndarray<double,3> a6)
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran_util_pythran::project_perpk3d()(a0, a1, a2, a3, a4, a5, a6);
...
static PyObject *
__pythran_wrap_project_perpk3d0(PyObject *self, PyObject *args)
{
    PyObject* args_obj[7+1];
    if(! PyArg_ParseTuple(args, "OOOOOOO", &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4], &args_obj[5], &args_obj[6]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,3>>(args_obj[3]) and is_convertible<pythonic::types::ndarray<double,3>>(args_obj[4]) and is_convertible<pythonic::types::ndarray<double,3>>(args_obj[5]) and is_convertible<pythonic::types::ndarray<double,3>>(args_obj[6]))
        ...
        return nullptr;
            ...
            static PyObject *
            __pythran_wrapall_project_perpk3d(PyObject *self, PyObject *args)
            {
                return pythonic::handle_python_exception([self, args]()
                -> PyObject* {

if(PyObject* obj = __pythran_wrap_project_perpk3d0(self, args))
    return obj;
...
static PyMethodDef Methods[] = {
    {
    "project_perpk3d",
    __pythran_wrapall_project_perpk3d,
    METH_VARARGS,
