...
#----------------------------------------------------------------------
    ...
    for element in $(".mdc-linear-progress")
        mdc.linearProgress.MDCLinearProgress.attachTo(element)

    for element in $(".mdc-tab-bar")
        mdc.tabs.MDCTabBar.attachTo(element)

    for element in $(".mdc-simple-menu")
        mdc.menu.MDCSimpleMenu.attachTo(element)

    for element in $(".mdc-dialog")
