...
THEME = {
    ...
    "--mdc-theme-text-secondary-on-secondary": "hsla(0,0%,100%,.7)",
    "--mdc-theme-text-hint-on-secondary": "hsla(0,0%,100%,.5)",
    "--mdc-theme-text-disabled-on-secondary": "hsla(0,0%,100%,.5)",
    "--mdc-theme-text-icon-on-secondary": "hsla(0,0%,100%,.5)",
    ...
    "--mdc-theme-text-secondary-on-secondary-dark": "hsla(0,0%,100%,.7)",
    "--mdc-theme-text-hint-on-secondary-dark": "hsla(0,0%,100%,.5)",
    "--mdc-theme-text-disabled-on-secondary-dark": "hsla(0,0%,100%,.5)",
    "--mdc-theme-text-icon-on-secondary-dark": "hsla(0,0%,100%,.5)",
...
.mdc-icon-toggle--primary:after, .mdc-icon-toggle--primary:before {
    background-color: rgba(var(--var-theme-primary), 0.14);
    opacity: 0;
}

//.mdc-icon-toggle--secondary:after, .mdc-icon-toggle--secondary:before {
//    background-color: rgba(var(--var-theme-secondary), 0.14);
//    opacity: 0;
//}
