...
(function (ui) {
    ...
    var Button = (function (_super) {
        ...
        Button.wire = function (conn, root) {
            ...
            elements
                ...
                .filter(function (node) { return UIElement.determineActionName(node) !== undefined; })
        ...
        Slider.wire = function (conn, root) {
            ...
            elements
                ...
                slider.changeCB = function (message) {
                    if (!slider.actionName)
                        throw Error('Failed to determine action name');
                    conn.emit(slider.actionName, message);
                };
                // handle events from backend
                if (!slider.wireSignal)
                    throw Error('Failed to determine action name');
    ...
    var Image = (function (_super) {
        ...
        Image.wire = function (conn, root) {
            ...
            console.log(elements.forEach(function (node) { return console.log(node, UIElement.determineWireSignal(node)); }));
            elements
                .filter(function (node) { return node.databenchUI === undefined; })
