...
===================================================
Radware driver for Openstack Ocata Neutron LBaaS v2
===================================================

This Radware driver is the LBaaS v2 service provider driver for openstack OCATA release.
...
- Install the radware_os_lb_v2_ocata package by executing the following command (use sudo if needed):
...
- Open the neutron configuration file named neutron_lbaas.conf. Under *[service_providers]* section, next to already defined providers, add a new line, declaring the Radware LOADBALANCER v2 provider. The neutron service provider configuration line format consists of three identifiers delimited by a colon:
	...
	- The service provider driver FQN. *radware_os_lb_v2_ocata.v2_driver.RadwareLBaaSV2Driver* is the driver class FQN

	.. code-block:: python

		service_provider = LOADBALANCERV2:rdwr:radware_os_lb_v2_ocata.v2_driver.RadwareLBaaSV2Driver
	...
	.. code-block:: python
		...
		service_provider = LOADBALANCERV2:rdwr:radware_os_lb_v2_ocata.v2_driver.RadwareLBaaSV2Driver:default
...
- The **radware_os_lb_v2_ocata** package contains following modules:
...
- Configure the new driver as another LBaaS v2 service provider in neutron configuration file
	...
	.. code-block:: python
		...
		service_provider = LOADBALANCERV2:my_rdwr:radware_os_lb_v2_ocata.my_driver.MyRadwareLBaaSV2Driver
