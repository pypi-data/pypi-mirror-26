...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vip', fields ['databaseinfra']
        db.create_unique(u'dbaas_networkapi_vip', ['databaseinfra_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vip', fields ['databaseinfra']
        db.delete_unique(u'dbaas_networkapi_vip', ['databaseinfra_id'])
    ...
    models = {
        u'dbaas_networkapi.vip': {
            ...
            'databaseinfra': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vip_databaseinfra'", 'unique': 'True', 'to': u"orm['physical.DatabaseInfra']"}),
            'dscp': ('django.db.models.fields.PositiveIntegerField', [], {}),
