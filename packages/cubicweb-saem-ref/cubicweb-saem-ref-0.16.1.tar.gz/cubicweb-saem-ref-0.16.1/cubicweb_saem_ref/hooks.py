...
def registration_callback(vreg):
    ...
    # Unregister SEDA "checkcard" hooks with are not wanted in saem_ref.
    from cubicweb_seda.hooks import (
        AddedCardinalityCheckedRelationHook,
        UpdatedCardinalityCheckedEntityHook,
    )
    vreg.unregister(AddedCardinalityCheckedRelationHook)
    vreg.unregister(UpdatedCardinalityCheckedEntityHook)
