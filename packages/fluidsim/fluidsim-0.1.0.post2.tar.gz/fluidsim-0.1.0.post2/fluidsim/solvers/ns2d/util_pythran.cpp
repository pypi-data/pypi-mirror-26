...
namespace __pythran_util_pythran
{
  struct compute_Frot
  {
    ...
    struct type
    {
      ...
      typedef decltype((std::declval<__type4>() * std::declval<__type5>())) __type12;
      typedef decltype((std::declval<__type3>() - std::declval<__type12>())) __type13;
      typedef typename pythonic::returnable<typename __combined<__type13,__type9>::type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 , typename argument_type4 >
    typename type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4>::result_type operator()(argument_type0 const & ux, argument_type1 const & uy, argument_type2 const & px_rot, argument_type3 const & py_rot, argument_type4 const & beta) const
    ;
  }  ;
  template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 , typename argument_type4 >
  typename compute_Frot::type<argument_type0, argument_type1, argument_type2, argument_type3, argument_type4>::result_type compute_Frot::operator()(argument_type0 const & ux, argument_type1 const & uy, argument_type2 const & px_rot, argument_type3 const & py_rot, argument_type4 const & beta) const
  {
    if ((beta == 0L))
    {
...
__pythran_wrap_compute_Frot0(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
        ...
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot1(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot2(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot3(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot4(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot5(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot6(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot7(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot8(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot9(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot10(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot11(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot12(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot13(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot14(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
__pythran_wrap_compute_Frot15(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3], &args_obj[4]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[2]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[3]) and is_convertible<double>(args_obj[4]))
...
PyErr_Clear();
                ...
                "Candidates are:\n   compute_Frot(ndarray<double,2>,ndarray<double,2>,ndarray<double,2>,ndarray<double,2>,double)\n   compute_Frot(ndarray<double,2>,ndarray<double,2>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,double)\n   compute_Frot(ndarray<double,2>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,double)\n   compute_Frot(ndarray<double,2>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,double)\n   compute_Frot(ndarray<double,2>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,ndarray<double,2>,double)\n   compute_Frot(ndarray<double,2>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,double)\n   compute_Frot(ndarray<double,2>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,double)\n   compute_Frot(ndarray<double,2>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,ndarray<double,2>,ndarray<double,2>,ndarray<double,2>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,ndarray<double,2>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,ndarray<double,2>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,numpy_texpr<ndarray<double,2>>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,ndarray<double,2>,double)\n   compute_Frot(numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,numpy_texpr<ndarray<double,2>>,double)\n"
                );
                return nullptr;
                });
            }
...
PYTHRAN_MODULE_INIT(util_pythran)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.8.3",
                                      "2017-11-04 00:30:50.856888",
                                      "d155a045148d1120fa81d12e4b9ac3db3122068a0d98b1084fa2345dc6cec0d8");
    if(not theDoc)
        PYTHRAN_RETURN;
