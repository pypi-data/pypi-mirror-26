...
namespace __pythran_util2d_pythran
{
  struct compute_increments_dim1
  {
    ...
    struct type
    {
      ...
      typedef typename pythonic::returnable<decltype((std::declval<__type3>() - std::declval<__type3>()))>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 >
    typename type<argument_type0, argument_type1>::result_type operator()(argument_type0 const & var, argument_type1 const & irx) const
    ;
  }  ;
  struct invlaplacian2_fft
  {
    ...
    struct type
    {
      ...
      typedef decltype(pythonic::types::make_tuple(std::declval<__type3>(), std::declval<__type3>())) __type5;
      typedef indexable<__type5> __type6;
      typedef double __type8;
      typedef container<typename std::remove_reference<__type8>::type> __type9;
      typedef typename pythonic::returnable<typename __combined<__type2,__type6,__type9>::type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
    typename type<argument_type0, argument_type1, argument_type2>::result_type operator()(argument_type0 const & a_fft, argument_type1 const & K4_not0, argument_type2 const & rank) const
    ;
  }  ;
  struct laplacian2_fft
  {
    ...
    ;
    template <typename argument_type0 , typename argument_type1 >
    typename type<argument_type0, argument_type1>::result_type operator()(argument_type0 const & a_fft, argument_type1 const & K4) const
    ;
  }  ;
  struct dealiasing_setofvar
  {
    ...
    struct type
    {
      ...
      typedef decltype(std::declval<typename std::remove_cv<typename std::remove_reference<decltype(pythonic::__builtin__::functor::range{})>::type>::type>()(std::declval<__type5>())) __type6;
      ...
      typedef decltype(std::declval<typename std::remove_cv<typename std::remove_reference<decltype(pythonic::__builtin__::functor::range{})>::type>::type>()(std::declval<__type8>())) __type9;
      ...
      typedef decltype(pythonic::types::make_tuple(std::declval<__type4>(), std::declval<__type7>(), std::declval<__type10>())) __type11;
      typedef __type0 __ptype4;
      typedef __type11 __ptype5;
      typedef typename pythonic::returnable<pythonic::types::none_type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 >
    typename type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type operator()(argument_type0&& setofvar_fft, argument_type1 const & where, argument_type2 const & n0, argument_type3 const & n1) const
    ;
  }  ;
  template <typename argument_type0 , typename argument_type1 >
  typename compute_increments_dim1::type<argument_type0, argument_type1>::result_type compute_increments_dim1::operator()(argument_type0 const & var, argument_type1 const & irx) const
  {
    ;
  ...
  template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
  typename invlaplacian2_fft::type<argument_type0, argument_type1, argument_type2>::result_type invlaplacian2_fft::operator()(argument_type0 const & a_fft, argument_type1 const & K4_not0, argument_type2 const & rank) const
  {
    typedef typename std::remove_cv<typename std::remove_reference<argument_type0>::type>::type __type0;
    typedef typename std::remove_cv<typename std::remove_reference<argument_type1>::type>::type __type1;
    typedef typename pythonic::assignable<decltype((pythonic::operator_::div(std::declval<__type0>(), std::declval<__type1>())))>::type __type2;
    ...
    typedef double __type8;
    typedef container<typename std::remove_reference<__type8>::type> __type9;
    typename pythonic::assignable<typename __combined<__type2,__type6,__type9>::type>::type invlap2_afft = (pythonic::operator_::div(a_fft, K4_not0));
    if ((rank == 0L))
    {
      invlap2_afft[pythonic::types::make_tuple(0L, 0L)] = 0.0;
    }
    return invlap2_afft;
  }
  template <typename argument_type0 , typename argument_type1 >
  typename laplacian2_fft::type<argument_type0, argument_type1>::result_type laplacian2_fft::operator()(argument_type0 const & a_fft, argument_type1 const & K4) const
  {
    return (a_fft * K4);
  }
  template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 >
  typename dealiasing_setofvar::type<argument_type0, argument_type1, argument_type2, argument_type3>::result_type dealiasing_setofvar::operator()(argument_type0&& setofvar_fft, argument_type1 const & where, argument_type2 const & n0, argument_type3 const & n1) const
  {
      ...
      {
        {
          ...
          {
            if (where[pythonic::types::make_tuple(i0, i1)])
            {
              {
                long  __target3 = nk;
                for (long  ik=0L; ik < __target3; ik += 1L)
                {
                  setofvar_fft[pythonic::types::make_tuple(ik, i0, i1)] = 0.0;
                }
              }
            }
          }
...
__pythran_wrap_dealiasing_setofvar0(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOO",
        ...
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<uint8_t,2>>(args_obj[1]) and is_convertible<long>(args_obj[2]) and is_convertible<long>(args_obj[3]))
...
__pythran_wrap_dealiasing_setofvar1(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2], &args_obj[3]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<uint8_t,2>>>(args_obj[1]) and is_convertible<long>(args_obj[2]) and is_convertible<long>(args_obj[3]))
...
__pythran_wrap_laplacian2_fft0(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
        ...
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,2>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]))
...
__pythran_wrap_laplacian2_fft1(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
                                     (char**)keywords, &args_obj[0], &args_obj[1]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,2>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]))
...
__pythran_wrap_laplacian2_fft2(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
                                     (char**)keywords, &args_obj[0], &args_obj[1]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<std::complex<double>,2>>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]))
...
__pythran_wrap_laplacian2_fft3(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
                                     (char**)keywords, &args_obj[0], &args_obj[1]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<std::complex<double>,2>>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]))
...
__pythran_wrap_invlaplacian2_fft0(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOO",
        ...
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,2>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<long>(args_obj[2]))
...
__pythran_wrap_invlaplacian2_fft1(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,2>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<long>(args_obj[2]))
...
__pythran_wrap_invlaplacian2_fft2(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<std::complex<double>,2>>>(args_obj[0]) and is_convertible<pythonic::types::ndarray<double,2>>(args_obj[1]) and is_convertible<long>(args_obj[2]))
...
__pythran_wrap_invlaplacian2_fft3(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<std::complex<double>,2>>>(args_obj[0]) and is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[1]) and is_convertible<long>(args_obj[2]))
...
__pythran_wrap_compute_increments_dim10(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
                                     (char**)keywords, &args_obj[0], &args_obj[1]))
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<double,2>>(args_obj[0]) and is_convertible<long>(args_obj[1]))
...
__pythran_wrap_compute_increments_dim11(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OO",
                                     (char**)keywords, &args_obj[0], &args_obj[1]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>>(args_obj[0]) and is_convertible<long>(args_obj[1]))
...
PyErr_Clear();
                ...
                "Invalid argument type for pythranized function `dealiasing_setofvar'.\n"
                "Candidates are:\n   dealiasing_setofvar(ndarray<std.complex<double>,3>,ndarray<uint8_t,2>,long,long)\n   dealiasing_setofvar(ndarray<std.complex<double>,3>,numpy_texpr<ndarray<uint8_t,2>>,long,long)\n"
                );
                return nullptr;
                });
            }
...
PyErr_Clear();
                ...
                PyErr_SetString(PyExc_TypeError,
                "Invalid argument type for pythranized function `laplacian2_fft'.\n"
                "Candidates are:\n   laplacian2_fft(ndarray<std.complex<double>,2>,ndarray<double,2>)\n   laplacian2_fft(ndarray<std.complex<double>,2>,numpy_texpr<ndarray<double,2>>)\n   laplacian2_fft(numpy_texpr<ndarray<std.complex<double>,2>>,ndarray<double,2>)\n   laplacian2_fft(numpy_texpr<ndarray<std.complex<double>,2>>,numpy_texpr<ndarray<double,2>>)\n"
                );
                return nullptr;
                });
            }
...
PyErr_Clear();
                ...
                PyErr_SetString(PyExc_TypeError,
                "Invalid argument type for pythranized function `invlaplacian2_fft'.\n"
                "Candidates are:\n   invlaplacian2_fft(ndarray<std.complex<double>,2>,ndarray<double,2>,long)\n   invlaplacian2_fft(ndarray<std.complex<double>,2>,numpy_texpr<ndarray<double,2>>,long)\n   invlaplacian2_fft(numpy_texpr<ndarray<std.complex<double>,2>>,ndarray<double,2>,long)\n   invlaplacian2_fft(numpy_texpr<ndarray<std.complex<double>,2>>,numpy_texpr<ndarray<double,2>>,long)\n"
                );
                return nullptr;
                });
            }
...
PyErr_Clear();
                ...
                PyErr_SetString(PyExc_TypeError,
                "Invalid argument type for pythranized function `compute_increments_dim1'.\n"
                "Candidates are:\n   compute_increments_dim1(ndarray<double,2>,long)\n   compute_increments_dim1(numpy_texpr<ndarray<double,2>>,long)\n"
                );
                return nullptr;
                });
            }
...
PYTHRAN_MODULE_INIT(util2d_pythran)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.8.3",
                                      "2017-11-04 00:30:53.738353",
                                      "557b985ae59bc40596bb42f2cf4cb60b6c5ee88c8cb710472aab70e290190346");
    if(not theDoc)
        PYTHRAN_RETURN;
