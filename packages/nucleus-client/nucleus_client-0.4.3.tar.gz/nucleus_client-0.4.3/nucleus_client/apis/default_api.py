...
class DefaultApi(object):
    ...
    def add_api_key(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_api_key(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.add_api_key_with_http_info(**kwargs)
        else:
            (data) = self.add_api_key_with_http_info(**kwargs)
            return data

    def add_api_key_with_http_info(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.add_api_key_with_http_info(callback=callback_function)
    ...
    def get_activities_with_http_info(self, client_id, activity_type, **kwargs):
        ...
        all_params = ['client_id', 'activity_type', 'integration_id', 'page']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
