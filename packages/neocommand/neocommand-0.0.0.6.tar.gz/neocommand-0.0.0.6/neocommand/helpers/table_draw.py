...
from intermake import resources as Res
...
class Table( IVisualisable ):
    ...
    def add_row( self, *columns, check = True ):
        """
...
def make_table( rows, indent: int = 0, wrap_value = 80, min_col_width = 1 ) -> str:
    """
    ...
    for row in rows:
        ...
        for i, col in enumerate( row ):
            ...
            for line in m_print_helper.wrap( str_col( col ), col_width[ i ] ):
