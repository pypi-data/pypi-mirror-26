...
from .exceptions import ProgrammerFuckedUp, BenignException
from . import basics
...
class ExecEnv(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            if not is_benign_error:
                ...
                if _the_manager.config['debug_mode']:
                    status_update = {
                        'event_type' : 'exec_env_error',
    ...
    def _next_iteration(self):
        ...
        if event is None:
            ...
            raise ProgrammerFuckedUp("a new iteration should only be requested when there is no local event scheduled, not for any other reason.")
    ...
    def process_server_response(self, server_response):
        ...
        if server_response['success']:
            ...
            if is_benign_error:
                ...
                raise ProgrammerFuckedUp(error_message)
###############################################################################################
