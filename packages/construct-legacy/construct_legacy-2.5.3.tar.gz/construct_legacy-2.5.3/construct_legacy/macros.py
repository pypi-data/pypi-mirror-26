import six
from construct_legacy.lib.py3compat import int2byte
from construct_legacy.lib import (BitStreamReader, BitStreamWriter, encode_bin, decode_bin)
from construct_legacy.core import (Struct, MetaField, StaticField, FormatField,
    OnDemand, Pointer, Switch, Value, RepeatUntil, MetaArray, Sequence, Range,
    Select, Pass, SizeofError, Buffered, Restream, Reconfig)
from construct_legacy.adapters import (BitIntegerAdapter, PaddingAdapter,
...
def GreedyRange(subcon):
    ...
    Example::
        ...
        >>> from construct_legacy import GreedyRange, UBInt8
...
def OptionalGreedyRange(subcon):
    ...
    Example::
        ...
        >>> from construct_legacy import OptionalGreedyRange, UBInt8
...
def String(name, length, encoding=None, padchar=None, paddir="right",
    ...
    Example::
        ...
        >>> from construct_legacy import String
