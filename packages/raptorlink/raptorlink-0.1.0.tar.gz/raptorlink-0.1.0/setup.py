...
usage:\n
>>> nosetests --with-plan-loader --plan-file <test_plan_file> --loop <loop_num>\n

start from command-line:
    nosetests --with-plan-loader --plan-file plan1 --loop 100 --report-to-raptor --

""",
    packages = ['raptorlink'],
    entry_points = {
        'nose.plugins': [
            'plan-loader = raptorlink.raptorlink:RaptorPlugin'
            ],
         },
)
