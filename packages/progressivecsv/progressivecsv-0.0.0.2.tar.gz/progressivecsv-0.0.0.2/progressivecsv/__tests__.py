...
class ProgressiveCsvTest( unittest.TestCase ):
    def test_one( self ):
        ...
        with open( temp_file_name, "r" ) as file:
            ...
            self.assertEqual( all[0], { "alpha": "a1", "beta": "X", "gamma": "X", "delta": "X" } )
            self.assertEqual( all[1], { "alpha": "a2", "beta": "X", "gamma": "X", "delta": "X" } )
            self.assertEqual( all[2], { "alpha": "a3", "beta": "X", "gamma": "X", "delta": "X" } )
            self.assertEqual( all[3], { "alpha": "a4", "beta": "b4", "gamma": "X", "delta": "X" } )
            self.assertEqual( all[4], { "alpha": "a5", "beta": "b5", "gamma": "X", "delta": "X" } )
            self.assertEqual( all[5], { "alpha": "a6", "beta": "b6", "gamma": "X", "delta": "X" } )
            self.assertEqual( all[6], { "alpha": "a7", "beta": "b7", "gamma": "c7", "delta": "X" } )
            self.assertEqual( all[7], { "alpha": "a8", "beta": "b8", "gamma": "c8", "delta": "X" } )
            self.assertEqual( all[8], { "alpha": "a9", "beta": "b9", "gamma": "c9", "delta": "X" } )
            self.assertEqual( all[9], { "alpha": "a10", "delta": "d10", "beta": "X", "gamma": "X" } )
            self.assertEqual( all[10], { "alpha": "a11", "delta": "d11", "beta": "X", "gamma": "X" } )
            self.assertEqual( all[11], { "alpha": "a12", "delta": "d12", "beta": "X", "gamma": "X" } )
            self.assertEqual( all[12], { "alpha": "a13", "gamma": "c13", "beta": "X", "delta": "X" } )
            self.assertEqual( all[13], { "alpha": "a14", "gamma": "c14", "beta": "X", "delta": "X" } )
            self.assertEqual( all[14], { "alpha": "a15", "gamma": "c15", "beta": "X", "delta": "X" } )
