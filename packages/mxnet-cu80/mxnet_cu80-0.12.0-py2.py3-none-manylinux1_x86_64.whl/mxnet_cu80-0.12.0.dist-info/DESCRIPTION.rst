...
This package supports Linux and Windows platform only, and requires
CUDA-8.0 for GPU acceleration. Also checkout other versions:
...
To install for other platforms (e.g. Raspberry Pi/ARM) or other versions
of CUDA, check `Installing
