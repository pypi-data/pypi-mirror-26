...
class TaskVersion(GenTaskProcessor):
    ...
    def run(self,ts,data,args):
        ...
        try:
            ...
            ts.details = "version check error: {}".format(str(e))
            ts.oc.error("version check error: {}".format(str(e)))
            return "ERR"
        ...
        if data is None :
            ...
            if args['path']:
                try:
                    ...
                    ts.oc.error('get keys error: {}'.format(str(e)))
                    return None                
