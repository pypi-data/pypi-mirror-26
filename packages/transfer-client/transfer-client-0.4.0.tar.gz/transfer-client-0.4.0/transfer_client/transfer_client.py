...
class TransferClient(object):
    ...
    def __init__(self, server_host, server_port, server_debug=False, verify=True, ca_bundle=None, cert=None):
        """Initialisation.
        ...
        # Toggle debugging at http.client level
    ...
    def _request(
        ...
        try:
            response = requests.request(
                method, 'https://{}:{}/{}/{}'.format(
                    self.server_host, self.server_port, self._version, endpoint),
