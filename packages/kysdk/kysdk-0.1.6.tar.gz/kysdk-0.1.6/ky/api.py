...
class Api:
    ...
    def get_stockinfo(self, symbols=None, field=None):
        """请求股票信息
        ...
        Returns:
            [type] -- list of dict
        """
        return self.call('get_stockinfo', [symbols, field])

    def get_share_float(self, start, end, num_days, symbols=None, field=None):
        """根据起始截止日期和股票代码列表以及指定获取的字段请求股票信息

        Arguments:

        """
        return self.call('get_share_float', [start, end, num_days, symbols, field])
    ...
    def get_fin_bs(self, start, end, reportType, symbols=None, field=None):
        ...
        Keyword Arguments:
            ...
            field {list} -- 返回值字段
        """
        return self.call('get_fin_bs', [start, end, reportType, symbols, field])

    def get_fin_is(self, start, end, reportType, symbols=None, field=None):
        ...
        Keyword Arguments:
            ...
            field {list} -- 返回值字段
        """
        return self.call('get_fin_is', [start, end, reportType, symbols, field])

    def get_fin_cf(self, start, end, reportType, symbols=None, field=None):
        ...
        Keyword Arguments:
            ...
            field {list} -- 返回值字段
        """
        return self.call('get_fin_cf', [start, end, reportType, symbols, field])

    def get_majorholder_trade(self, start, end, symbols=None, field=None):
        ...
        Keyword Arguments:
            ...
            field {list} -- 返回值字段
        """
        return self.call('get_majorholder_trade', [start, end, symbols, field])

    def get_yanbao_analysis(self, end, start=None, num_days=None, symbols=None):
        ...
        Keyword Arguments:
            ...
            symbols {list} -- 股票代码列表
        """
        return self.call('get_yanbao_analysis', [end, start, num_days, symbols])

    def get_share_unlock(self, start, end, symbols=None, field=None):
        ...
        """
        return self.call('get_share_unlock', [start, end, symbols, field])
