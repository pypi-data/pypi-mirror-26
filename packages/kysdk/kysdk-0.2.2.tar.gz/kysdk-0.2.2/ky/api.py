...
class Api:
    ...
    def get_stock_info_latest(self, symbols=None, field=None):
        """请求股票信息
        ...
        Returns:
            [type] -- list of dict
        """
        return self.call('get_stock_info_latest', [symbols, field])

    def get_stock_info_roll(self, symbols, end, start, field=None):
        """根据起始截止日期和股票代码列表以及指定获取的字段请求股票信息

        Arguments:

        """
        return self.call('get_stock_info_roll', [symbols, end, start, field])
