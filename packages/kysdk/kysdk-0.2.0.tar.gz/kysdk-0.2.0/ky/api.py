...
class Api:
    ...
    def get_trading_dates_by_date_range(self, end, start, exchange='SHSE'):
        """获取指定日期内的交易日
        ...
        Keyword Arguments:
            exchange {str} -- [description] (default: {'SHSE'})
    ...
    def get_recent_of_stock(self, symbol, adjType='none', field=None):
        """获取股票最新日线
        Arguments:
            symbol {str} -- symbol
        Keyword Arguments:
            ...
            field {list} -- 字段类型
        """
        return self.call('get_recent_of_stock', [symbol, adjType, field])