...
#    def test_get_package_nvras_f24(self, fakepdc):
        """F24: Different layout again under /Everything. mock values
        are same as for F18. Commented-out lines are for testing the
        PDC version of the method, which is currently disabled: see
        comment in Pungi4Release class.
        """
...
#    def test_get_package_nvras_mod_f27(self, fakepdc):
