...
'''
DESCRIPTION = '''acrilib is a python library of programming patterns that we use, at acrisel, in Python projects and choose to contribute to Python community'''
