...
#    _kube_train_cluster_template_registry = {'train-cluster-cpu': (['train-cluster-cpu.yaml.template'], [])}
    ...
    def version(self):
        ...
        print('')
        print('capabilities_enabled: %s' % ['server', 'predict', 'version'])
        print('capabilities_disabled: %s' % ['cluster', 'experiment', 'optimize'])
        print('')
    ...
    def _create_server_Dockerfile(self,
                                       model_type,
                                       model_name,
                                       model_tag,
                                       templates_path,
    ...
    def server_build(self,
        ...
        if build_type == 'docker':
            generated_Dockerfile = self._create_server_Dockerfile(model_type=model_type, 
    ...
    def _create_cluster_Kubernetes_yaml(self,
                                                        model_type,
                                                        model_name,
                                                        model_tag,
                                                        templates_path=_default_templates_path,
    ...
    def cluster_start(self,
        ...
        rendered_yamls = self._create_cluster_Kubernetes_yaml(model_type=model_type,
                                          model_name=model_name,
                                          model_tag=model_tag,
                                          templates_path=templates_path,
    ...
    def _cluster_deploy_remote(self,
                                    model_type,
                                    model_name,
                                    model_tag,
                                    model_path,
