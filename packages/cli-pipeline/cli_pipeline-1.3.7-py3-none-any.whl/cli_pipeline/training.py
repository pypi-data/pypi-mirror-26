...
class PipelineCli(object):
    ...
    def version(self):
        ...
        print('capabilities_disabled: %s' % ['prediction_cluster', 'training_cluster', 'optimize', 'prediction_router'])
        print('')
    ...
    def prediction_cluster_connect(self,
                             model_type,
                             model_name,
                             model_tag,
                             local_port=None,
        ...
        print("")
        print("capability['prediction_cluster'] is not enabled.")
        print("")
        self.version()
    ...
    def training_cluster_start(self,
        ...
        generated_yaml = self._create_training_cluster_Kubernetes_yaml(model_type,
                                                                 model_name,
                                                                 model_tag,
    ...
    def _create_prediction_server_Dockerfile(self,
                                       model_type,
                                       model_name,
                                       model_tag,
                                       templates_path,
    ...
    def prediction_server_build(self,
                          model_type,
                          model_name,
                          model_tag,
                          model_path,
        ...
        if build_type == 'docker':
            generated_Dockerfile = self._create_prediction_server_Dockerfile(model_type=model_type, 
                                                                model_name=model_name,
                                                                model_tag=model_tag,
                                                                templates_path=templates_path,
                                                                build_path=build_path)
    ...
    def _create_prediction_cluster_Kubernetes_yaml(self,
                                                        model_type,
                                                        model_name,
                                                        model_tag,
                                                        templates_path=_default_templates_path,
    ...
    def prediction_server_shell(self,
                     model_type,
                     model_name,
                     model_tag,
                     build_prefix='predict'):
    ...
    def prediction_server_push(self,
                         model_type,
                         model_name,
                         model_tag,
                         build_registry_url='docker.io',
    ...
    def prediction_server_pull(self,
                         model_type,
                         model_name,
                         model_tag,
                         build_registry_url='docker.io',
    ...
    def prediction_server_start(self,
                          model_type,
                          model_name,
                          model_tag,
                          build_registry_url='docker.io',
    ...
    def prediction_server_stop(self,
                         model_type,
                         model_name,
                         model_tag,
                         build_prefix='predict'): 
    ...
    def prediction_server_logs(self,
                         model_type,
                         model_name,
                         model_tag,
                         build_prefix='predict'):
    ...
    def prediction_cluster_start(self,
                           model_type,
                           model_name,
                           model_tag,
                           templates_path=_default_templates_path,
        ...
        rendered_yamls = self._create_prediction_cluster_Kubernetes_yaml(model_type=model_type,
                                          model_name=model_name,
                                          model_tag=model_tag,
                                          templates_path=templates_path,
    ...
    def _prediction_cluster_deploy_remote(self,
                                    model_type,
                                    model_name,
                                    model_tag,
                                    model_path,
    ...
    def optimize(self,
        ...
        print('optimizer_type: %s' % optimizer_type)
        print('optimizer_params: %s' % optimizer_params)
        print('')
    ...
    def prediction_cluster_status(self):
        self._cluster_status()


    def training_cluster_status(self):
        self._cluster_status()
...
#        self._get_all_available_services()
        ...
        with warnings.catch_warnings():
            ...
            services = response.items
            for svc in services:
                self._prediction_cluster_describe(service_name=svc.metadata.name)
    ...
    def prediction_cluster_shell(self,
                           model_type,
                           model_name,
                           model_tag,
                           build_prefix='predict',
    ...
    def prediction_cluster_logs(self,
                          model_type,
                          model_name,
                          model_tag,
                          build_prefix='predict',
    ...
    def prediction_cluster_describe(self,
                              model_type,
                              model_name,
                              model_tag,
                              build_prefix='predict',
    ...
    def prediction_cluster_scale(self,
                           model_type,
                           model_name,
                           model_tag,
                           replicas,
    ...
    def prediction_router_register(self,
                               model_type,
                               model_name,
                               model_tag):

        print("")
        print("capability['prediction_router'] is not enabled.")
        print("")
        self.version()


    def prediction_router_deregister(self,
                                 model_type,
                                 model_name,
                                 model_tag):
    ...
    def prediction_router_split(self,
                            model_type,
                            model_name,
                            model_tag,
                            percentage_traffic):
    ...
    def prediction_router_shadow(self,
                             model_type,
                             model_name,
                             model_tag,
                             percentage_traffic):
    ...
    def prediction_router_status(self):
        print("")
        print("capability['prediction_router'] is not enabled.")
        print("")
        self.version()
    ...
    def prediction_router_describe(self,
                               model_type,
                               model_name,
                               model_tag):
...
#        print("")
    ...
    def prediction_cluster_stop(self,
                          model_type,
                          model_name,
                          model_tag,
                          build_prefix='predict',
