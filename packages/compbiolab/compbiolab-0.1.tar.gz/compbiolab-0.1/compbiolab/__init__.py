...
def plot_dist(data, legend=True, names='default' , color='default', window_size=50, seaborn_style='default',
    ...
    if color == 'default':
        color = ('#aa00ff','#DC143C','#FF8C00','#008B8B','#1E90FF','#FF1493','#4B0082','#FF69B4','#32CD32')
    elif type(color) == str:
        color=[color, '0']
    
    if names == 'default':
        names = ('Serie 1', 'Serie 2', 'Serie 3', 'Serie 4', 'Serie 5', 'Serie 6', 'Serie 7', 'Serie 8', 'Serie 9')
    elif type(names) == str:
        names=[names, '0']
    
    if seaborn_style == 'default':
