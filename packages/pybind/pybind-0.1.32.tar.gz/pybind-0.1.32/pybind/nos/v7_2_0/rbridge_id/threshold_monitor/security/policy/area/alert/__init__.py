...
class alert(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__above = YANGDynClass(base=above.above, is_container='container', presence=False, yang_name="above", rest_name="above", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='container', is_config=True)
  ...
  def _set_above(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=above.above, is_container='container', presence=False, yang_name="above", rest_name="above", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """above must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=above.above, is_container='container', presence=False, yang_name="above", rest_name="above", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='container', is_config=True)""",
        })
