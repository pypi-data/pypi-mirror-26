...
class area(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'10GLR': {'value': 3}, u'QSFP': {'value': 5}, u'100GSR': {'value': 7}, u'1GLR': {'value': 1}, u'1GSR': {'value': 0}, u'10GSR': {'value': 2}, u'10GUSR': {'value': 4}},), is_leaf=True, yang_name="type", rest_name="type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-threshold-monitor', defining_module='brocade-threshold-monitor', yang_type='enumeration', is_config=True)
