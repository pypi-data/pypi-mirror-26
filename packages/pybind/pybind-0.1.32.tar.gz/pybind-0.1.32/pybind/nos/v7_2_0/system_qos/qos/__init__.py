...
class qos(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__service_policy = YANGDynClass(base=YANGListType("direction policy_map_name",service_policy.service_policy, yang_name="service-policy", rest_name="service-policy", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='direction policy-map-name', extensions=None), is_container='list', yang_name="service-policy", rest_name="service-policy", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-policer', defining_module='brocade-policer', yang_type='list', is_config=True)
