...
class database(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__lsp_entry = YANGDynClass(base=YANGListType("lsp_level lsp_id",lsp_entry.lsp_entry, yang_name="lsp-entry", rest_name="lsp-entry", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='lsp-level lsp-id', extensions=None), is_container='list', yang_name="lsp-entry", rest_name="lsp-entry", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='list', is_config=False)
