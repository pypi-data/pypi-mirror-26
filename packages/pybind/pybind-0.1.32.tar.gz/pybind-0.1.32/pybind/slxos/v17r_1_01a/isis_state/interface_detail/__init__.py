...
class interface_detail(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__isis_intf = YANGDynClass(base=YANGListType("intf_type intf_number",isis_intf.isis_intf, yang_name="isis-intf", rest_name="isis-intf", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='intf-type intf-number', extensions=None), is_container='list', yang_name="isis-intf", rest_name="isis-intf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='list', is_config=False)
