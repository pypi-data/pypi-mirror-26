...
class ipv6_routes(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ipv6_route_entry = YANGDynClass(base=YANGListType("ipv6_dest_addr ipv6_prefix_len",ipv6_route_entry.ipv6_route_entry, yang_name="ipv6-route-entry", rest_name="ipv6-route-entry", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='ipv6-dest-addr ipv6-prefix-len', extensions=None), is_container='list', yang_name="ipv6-route-entry", rest_name="ipv6-route-entry", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='list', is_config=False)
