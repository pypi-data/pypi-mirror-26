...
class spf_log_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__spf_log_levels = YANGDynClass(base=YANGListType("level",spf_log_levels.spf_log_levels, yang_name="spf-log-levels", rest_name="spf-log-levels", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='level', extensions=None), is_container='list', yang_name="spf-log-levels", rest_name="spf-log-levels", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='list', is_config=False)
