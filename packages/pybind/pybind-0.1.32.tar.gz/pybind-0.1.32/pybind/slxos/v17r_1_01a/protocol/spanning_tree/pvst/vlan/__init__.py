...
class vlan(PybindBase):
  ...
  def _get_aging_time(self):
    """
    Getter method for aging_time, mapped from YANG variable /protocol/spanning_tree/pvst/vlan/aging_time (uint32)
    """
    return self.__aging_time
      
  def _set_aging_time(self, v, load=False):
    """
    Setter method for aging_time, mapped from YANG variable /protocol/spanning_tree/pvst/vlan/aging_time (uint32)
    If this variable is read-only (config: false) in the
