...
class protocol(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__cfm','__link_oam','__edge_loop_detection','__spanning_tree','__lldp','__udld',)
...
leaf
  ...
  _pyangbind_elements = {'cfm': cfm, 'link_oam': link_oam, 'edge_loop_detection': edge_loop_detection, 'spanning_tree': spanning_tree, 'lldp': lldp, 'udld': udld, }
