...
class bridge_domain_statistics(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__lif_statistics = YANGDynClass(base=YANGListType("lif_id",lif_statistics.lif_statistics, yang_name="lif-statistics", rest_name="lif-statistics", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='lif-id', extensions=None), is_container='list', yang_name="lif-statistics", rest_name="lif-statistics", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
