...
class sub_interface_statistics_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__bridge_domain_statistics = YANGDynClass(base=YANGListType("bd_id",bridge_domain_statistics.bridge_domain_statistics, yang_name="bridge-domain-statistics", rest_name="bridge-domain-statistics", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions=None), is_container='list', yang_name="bridge-domain-statistics", rest_name="bridge-domain-statistics", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    self.__vlan_statistics = YANGDynClass(base=YANGListType("vlan_id",vlan_statistics.vlan_statistics, yang_name="vlan-statistics", rest_name="vlan-statistics", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vlan-id', extensions=None), is_container='list', yang_name="vlan-statistics", rest_name="vlan-statistics", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
