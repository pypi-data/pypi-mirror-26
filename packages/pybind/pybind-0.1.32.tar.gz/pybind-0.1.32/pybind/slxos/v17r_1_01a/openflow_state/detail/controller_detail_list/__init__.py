...
class controller_detail_list(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__controller_info = YANGDynClass(base=controller_info.controller_info, is_container='container', presence=False, yang_name="controller-info", rest_name="controller-info", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='container', is_config=False)
    self.__controller_async_list = YANGDynClass(base=YANGListType("async_type",controller_async_list.controller_async_list, yang_name="controller-async-list", rest_name="controller-async-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='async-type', extensions=None), is_container='list', yang_name="controller-async-list", rest_name="controller-async-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=False)
  ...
  def _set_controller_info(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=controller_info.controller_info, is_container='container', presence=False, yang_name="controller-info", rest_name="controller-info", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """controller_info must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=controller_info.controller_info, is_container='container', presence=False, yang_name="controller-info", rest_name="controller-info", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='container', is_config=False)""",
        })
