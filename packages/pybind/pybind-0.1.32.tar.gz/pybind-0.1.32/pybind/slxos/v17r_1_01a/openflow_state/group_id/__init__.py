...
class group_id(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__group_bucket_list = YANGDynClass(base=YANGListType("bucket_id",group_bucket_list.group_bucket_list, yang_name="group-bucket-list", rest_name="group-bucket-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bucket-id', extensions=None), is_container='list', yang_name="group-bucket-list", rest_name="group-bucket-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=False)
