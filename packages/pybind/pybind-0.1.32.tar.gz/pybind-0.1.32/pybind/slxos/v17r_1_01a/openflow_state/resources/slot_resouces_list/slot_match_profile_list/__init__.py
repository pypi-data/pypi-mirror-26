...
class slot_match_profile_list(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__slot_chip_resource_list = YANGDynClass(base=YANGListType("slot_chip_idx",slot_chip_resource_list.slot_chip_resource_list, yang_name="slot-chip-resource-list", rest_name="slot-chip-resource-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='slot-chip-idx', extensions=None), is_container='list', yang_name="slot-chip-resource-list", rest_name="slot-chip-resource-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=False)
