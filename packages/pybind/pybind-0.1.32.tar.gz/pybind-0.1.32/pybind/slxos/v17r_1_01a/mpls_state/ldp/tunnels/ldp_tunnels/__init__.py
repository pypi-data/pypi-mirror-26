...
class ldp_tunnels(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__out_segments = YANGDynClass(base=YANGListType("outgoing_interface",out_segments.out_segments, yang_name="out-segments", rest_name="out-segments", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='outgoing-interface', extensions=None), is_container='list', yang_name="out-segments", rest_name="out-segments", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
