...
class backup(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__backup_transit = YANGDynClass(base=YANGListType("backup_from_address backup_to_address backup_name",backup_transit.backup_transit, yang_name="backup-transit", rest_name="backup-transit", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='backup-from-address backup-to-address backup-name', extensions=None), is_container='list', yang_name="backup-transit", rest_name="backup-transit", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
    ...
    self.__backup_ingress = YANGDynClass(base=YANGListType("backup_from_address backup_to_address backup_name",backup_ingress.backup_ingress, yang_name="backup-ingress", rest_name="backup-ingress", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='backup-from-address backup-to-address backup-name', extensions=None), is_container='list', yang_name="backup-ingress", rest_name="backup-ingress", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
