...
class instances(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__lsp_hops = YANGDynClass(base=YANGListType("hop_index hop_address",lsp_hops.lsp_hops, yang_name="lsp-hops", rest_name="lsp-hops", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='hop-index hop-address', extensions=None), is_container='list', yang_name="lsp-hops", rest_name="lsp-hops", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
    ...
    self.__admin_group_lists = YANGDynClass(base=YANGListType("list_type",admin_group_lists.admin_group_lists, yang_name="admin-group-lists", rest_name="admin-group-lists", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='list-type', extensions=None), is_container='list', yang_name="admin-group-lists", rest_name="admin-group-lists", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
