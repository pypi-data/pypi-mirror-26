...
class psbs(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__session_rro_hops = YANGDynClass(base=YANGListType("ip_addr",session_rro_hops.session_rro_hops, yang_name="session-rro-hops", rest_name="session-rro-hops", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='ip-addr', extensions=None), is_container='list', yang_name="session-rro-hops", rest_name="session-rro-hops", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
    ...
    self.__session_ero_hops = YANGDynClass(base=YANGListType("ip_addr",session_ero_hops.session_ero_hops, yang_name="session-ero-hops", rest_name="session-ero-hops", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='ip-addr', extensions=None), is_container='list', yang_name="session-ero-hops", rest_name="session-ero-hops", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
