...
class tunnels(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ldp_tunnels = YANGDynClass(base=YANGListType("tunnel_destination prefix_length",ldp_tunnels.ldp_tunnels, yang_name="ldp-tunnels", rest_name="ldp-tunnels", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='tunnel-destination prefix-length', extensions=None), is_container='list', yang_name="ldp-tunnels", rest_name="ldp-tunnels", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
