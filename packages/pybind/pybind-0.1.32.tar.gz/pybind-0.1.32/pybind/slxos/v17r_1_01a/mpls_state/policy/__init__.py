...
class policy(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__admin_groups = YANGDynClass(base=YANGListType("name",admin_groups.admin_groups, yang_name="admin-groups", rest_name="admin-groups", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='name', extensions=None), is_container='list', yang_name="admin-groups", rest_name="admin-groups", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
    ...
    self.__rsvp_flooding_thresholds = YANGDynClass(base=YANGListType("threshold_type",rsvp_flooding_thresholds.rsvp_flooding_thresholds, yang_name="rsvp-flooding-thresholds", rest_name="rsvp-flooding-thresholds", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='threshold-type', extensions=None), is_container='list', yang_name="rsvp-flooding-thresholds", rest_name="rsvp-flooding-thresholds", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
