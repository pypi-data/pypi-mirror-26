...
class ldp_fec_vc(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__vc_downstream = YANGDynClass(base=YANGListType("mapping_index",vc_downstream.vc_downstream, yang_name="vc-downstream", rest_name="vc-downstream", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='mapping-index', extensions=None), is_container='list', yang_name="vc-downstream", rest_name="vc-downstream", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
