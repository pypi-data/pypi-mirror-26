...
class top(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__cpu_top_process_information = YANGDynClass(base=YANGListType("cpu_process_id",cpu_top_process_information.cpu_top_process_information, yang_name="cpu-top-process-information", rest_name="cpu-top-process-information", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cpu-process-id', extensions=None), is_container='list', yang_name="cpu-top-process-information", rest_name="cpu-top-process-information", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-RAS-operational', defining_module='brocade-RAS-operational', yang_type='list', is_config=False)
