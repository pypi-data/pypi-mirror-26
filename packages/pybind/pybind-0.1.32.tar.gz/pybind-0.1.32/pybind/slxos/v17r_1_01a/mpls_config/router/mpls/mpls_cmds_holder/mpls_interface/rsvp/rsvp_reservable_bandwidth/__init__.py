...
class rsvp_reservable_bandwidth(PybindBase):
  ...
  _rest_name = 'rsvp-reservable-bandwidth'
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__reservable_bandwidth = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..2000000000']}), is_leaf=True, yang_name="reservable-bandwidth", rest_name="reservable-bandwidth", parent=self, choice=(u'rsvp-reservable-bandwidth-options', u'reservable-bandwidth-case-exact'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='uint32', is_config=True)
    self.__reservable_bandwidth_percentage = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..100']}), is_leaf=True, yang_name="reservable-bandwidth-percentage", rest_name="reservable-bandwidth-percentage", parent=self, choice=(u'rsvp-reservable-bandwidth-options', u'reservable-bandwidth-case-percentage'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='uint32', is_config=True)
