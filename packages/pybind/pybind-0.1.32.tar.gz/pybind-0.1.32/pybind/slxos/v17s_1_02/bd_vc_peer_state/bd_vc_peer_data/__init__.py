...
class bd_vc_peer_data(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__vc_proto_tnnl = YANGDynClass(base=YANGListType("vc_proto_name",vc_proto_tnnl.vc_proto_tnnl, yang_name="vc-proto-tnnl", rest_name="vc-proto-tnnl", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vc-proto-name', extensions=None), is_container='list', yang_name="vc-proto-tnnl", rest_name="vc-proto-tnnl", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='list', is_config=False)
    self.__vc_assigned_lsp = YANGDynClass(base=YANGListType("vc_lsp_name",vc_assigned_lsp.vc_assigned_lsp, yang_name="vc-assigned-lsp", rest_name="vc-assigned-lsp", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vc-lsp-name', extensions=None), is_container='list', yang_name="vc-assigned-lsp", rest_name="vc-assigned-lsp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='list', is_config=False)
