...
class bfd(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__bfd_ipv6_static_route = YANGDynClass(base=YANGListType("bfd_ipv6_static_route_dest bfd_ipv6_static_route_src",bfd_ipv6_static_route.bfd_ipv6_static_route, yang_name="bfd-ipv6-static-route", rest_name="bfd-ipv6-static-route", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bfd-ipv6-static-route-dest bfd-ipv6-static-route-src', extensions=None), is_container='list', yang_name="bfd-ipv6-static-route", rest_name="bfd-ipv6-static-route", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='list', is_config=True)
    self.__ipv6_holdover_interval = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'0..30']}), is_leaf=True, yang_name="ipv6-holdover-interval", rest_name="ipv6-holdover-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='uint8', is_config=True)
    self.__bfd_ipv6_link_local_static_route = YANGDynClass(base=YANGListType("bfd_ipv6_link_local_dest bfd_ipv6_link_local_src bfd_interface_type bfd_interface_name",bfd_ipv6_link_local_static_route.bfd_ipv6_link_local_static_route, yang_name="bfd-ipv6-link-local-static-route", rest_name="bfd-ipv6-link-local-static-route", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bfd-ipv6-link-local-dest bfd-ipv6-link-local-src bfd-interface-type bfd-interface-name', extensions=None), is_container='list', yang_name="bfd-ipv6-link-local-static-route", rest_name="bfd-ipv6-link-local-static-route", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='list', is_config=True)
  ...
  def _set_ipv6_holdover_interval(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'0..30']}), is_leaf=True, yang_name="ipv6-holdover-interval", rest_name="ipv6-holdover-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='uint8', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv6_holdover_interval must be of a type compatible with uint8""",
          'defined-type': "uint8",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'0..30']}), is_leaf=True, yang_name="ipv6-holdover-interval", rest_name="ipv6-holdover-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='uint8', is_config=True)""",
        })
