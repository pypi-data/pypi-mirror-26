...
class trigger(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__trigger_id','__raslog',)
  ...
  __choices__ = {u'trigger-choice': {u'raslog': [u'raslog']}}
  _pyangbind_elements = {'trigger_id': trigger_id, 'raslog': raslog, }
