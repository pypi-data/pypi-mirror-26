...
class map_apply(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__apply_exp_traffic_class_map_name','__apply_traffic_class_exp_map_name','__apply_dscp_exp_map_name','__apply_exp_dscp_map_name',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__apply_traffic_class_exp_map_name = YANGDynClass(base=apply_traffic_class_exp_map_name.apply_traffic_class_exp_map_name, is_container='container', presence=False, yang_name="apply-traffic-class-exp-map-name", rest_name="apply-traffic-class-exp-map-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-apply-qos-mpls', defining_module='brocade-apply-qos-mpls', yang_type='container', is_config=True)
    self.__apply_exp_dscp_map_name = YANGDynClass(base=apply_exp_dscp_map_name.apply_exp_dscp_map_name, is_container='container', presence=False, yang_name="apply-exp-dscp-map-name", rest_name="apply-exp-dscp-map-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-apply-qos-mpls', defining_module='brocade-apply-qos-mpls', yang_type='container', is_config=True)
    self.__apply_exp_traffic_class_map_name = YANGDynClass(base=apply_exp_traffic_class_map_name.apply_exp_traffic_class_map_name, is_container='container', presence=False, yang_name="apply-exp-traffic-class-map-name", rest_name="apply-exp-traffic-class-map-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-apply-qos-mpls', defining_module='brocade-apply-qos-mpls', yang_type='container', is_config=True)
    self.__apply_dscp_exp_map_name = YANGDynClass(base=apply_dscp_exp_map_name.apply_dscp_exp_map_name, is_container='container', presence=False, yang_name="apply-dscp-exp-map-name", rest_name="apply-dscp-exp-map-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-apply-qos-mpls', defining_module='brocade-apply-qos-mpls', yang_type='container', is_config=True)
  ...
  _pyangbind_elements = {'apply_exp_traffic_class_map_name': apply_exp_traffic_class_map_name, 'apply_traffic_class_exp_map_name': apply_traffic_class_exp_map_name, 'apply_dscp_exp_map_name': apply_dscp_exp_map_name, 'apply_exp_dscp_map_name': apply_exp_dscp_map_name, }
