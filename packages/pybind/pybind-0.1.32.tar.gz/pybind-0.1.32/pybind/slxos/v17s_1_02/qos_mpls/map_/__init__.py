...
class map_(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__exp_traffic_class','__traffic_class_exp','__dscp_exp','__exp_dscp',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__exp_dscp = YANGDynClass(base=YANGListType("exp_dscp_map_name",exp_dscp.exp_dscp, yang_name="exp-dscp", rest_name="exp-dscp", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='exp-dscp-map-name', extensions=None), is_container='list', yang_name="exp-dscp", rest_name="exp-dscp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-qos-mpls', defining_module='brocade-qos-mpls', yang_type='list', is_config=True)
    self.__traffic_class_exp = YANGDynClass(base=YANGListType("traffic_class_exp_map_name",traffic_class_exp.traffic_class_exp, yang_name="traffic-class-exp", rest_name="traffic-class-exp", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='traffic-class-exp-map-name', extensions=None), is_container='list', yang_name="traffic-class-exp", rest_name="traffic-class-exp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-qos-mpls', defining_module='brocade-qos-mpls', yang_type='list', is_config=True)
    self.__dscp_exp = YANGDynClass(base=YANGListType("dscp_exp_map_name",dscp_exp.dscp_exp, yang_name="dscp-exp", rest_name="dscp-exp", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='dscp-exp-map-name', extensions=None), is_container='list', yang_name="dscp-exp", rest_name="dscp-exp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-qos-mpls', defining_module='brocade-qos-mpls', yang_type='list', is_config=True)
    self.__exp_traffic_class = YANGDynClass(base=YANGListType("exp_traffic_class_map_name",exp_traffic_class.exp_traffic_class, yang_name="exp-traffic-class", rest_name="exp-traffic-class", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='exp-traffic-class-map-name', extensions=None), is_container='list', yang_name="exp-traffic-class", rest_name="exp-traffic-class", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-qos-mpls', defining_module='brocade-qos-mpls', yang_type='list', is_config=True)
  ...
  _pyangbind_elements = {'exp_traffic_class': exp_traffic_class, 'traffic_class_exp': traffic_class_exp, 'dscp_exp': dscp_exp, 'exp_dscp': exp_dscp, }
