...
class client_info_list(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__config_bds = YANGDynClass(base=YANGListType("bd_id",config_bds.config_bds, yang_name="config-bds", rest_name="config-bds", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions=None), is_container='list', yang_name="config-bds", rest_name="config-bds", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    self.__config_vlans = YANGDynClass(base=YANGListType("vlan_id",config_vlans.config_vlans, yang_name="config-vlans", rest_name="config-vlans", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vlan-id', extensions=None), is_container='list', yang_name="config-vlans", rest_name="config-vlans", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
