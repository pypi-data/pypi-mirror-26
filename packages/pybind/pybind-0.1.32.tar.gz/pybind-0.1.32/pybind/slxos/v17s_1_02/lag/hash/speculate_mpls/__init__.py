...
class speculate_mpls(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__enable_eth_ip = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'enable': {'value': 1}, u'inner-ipv6-raw': {'value': 5}, u'inner-eth': {'value': 2}, u'inner-ipv6-tag': {'value': 6}, u'inner-ip-tag': {'value': 4}, u'inner-ip-raw': {'value': 3}},), is_leaf=True, yang_name="enable-eth-ip", rest_name="enable-eth-ip", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-rbridge-lag', defining_module='brocade-rbridge-lag', yang_type='enumeration', is_config=True)
