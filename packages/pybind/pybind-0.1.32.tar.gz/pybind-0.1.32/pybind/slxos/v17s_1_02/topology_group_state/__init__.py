...
class topology_group_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__topology_group_data = YANGDynClass(base=YANGListType("topology_group_id",topology_group_data.topology_group_data, yang_name="topology-group-data", rest_name="topology-group-data", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='topology-group-id', extensions=None), is_container='list', yang_name="topology-group-data", rest_name="topology-group-data", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
