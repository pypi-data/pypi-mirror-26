...
class main_interface_tunnel(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__logical_interface_tunnel = YANGDynClass(base=logical_interface_tunnel.logical_interface_tunnel, is_container='container', presence=False, yang_name="logical-interface-tunnel", rest_name="logical-interface-tunnel", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=False)
  ...
  def _set_logical_interface_tunnel(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=logical_interface_tunnel.logical_interface_tunnel, is_container='container', presence=False, yang_name="logical-interface-tunnel", rest_name="logical-interface-tunnel", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """logical_interface_tunnel must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=logical_interface_tunnel.logical_interface_tunnel, is_container='container', presence=False, yang_name="logical-interface-tunnel", rest_name="logical-interface-tunnel", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=False)""",
        })
