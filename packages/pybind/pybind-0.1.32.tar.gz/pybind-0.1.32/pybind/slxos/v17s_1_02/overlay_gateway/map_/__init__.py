...
class map_(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__vlan_and_bd = YANGDynClass(base=vlan_and_bd.vlan_and_bd, is_container='container', presence=False, yang_name="vlan-and-bd", rest_name="vlan-and-bd", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-tunnels', defining_module='brocade-tunnels', yang_type='container', is_config=True)
    self.__bd_vni_mapping = YANGDynClass(base=YANGListType("bdid",bd_vni_mapping.bd_vni_mapping, yang_name="bd-vni-mapping", rest_name="bd-vni-mapping", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bdid', extensions=None), is_container='list', yang_name="bd-vni-mapping", rest_name="bd-vni-mapping", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-tunnels', defining_module='brocade-tunnels', yang_type='list', is_config=True)
    self.__vlan_vni_mapping = YANGDynClass(base=YANGListType("vid",vlan_vni_mapping.vlan_vni_mapping, yang_name="vlan-vni-mapping", rest_name="vlan-vni-mapping", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vid', extensions=None), is_container='list', yang_name="vlan-vni-mapping", rest_name="vlan-vni-mapping", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-tunnels', defining_module='brocade-tunnels', yang_type='list', is_config=True)
