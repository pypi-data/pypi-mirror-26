...
class group_prio(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__group_prio_config_shaper_wfq = YANGDynClass(base=group_prio_config_shaper_wfq.group_prio_config_shaper_wfq, is_container='container', presence=False, yang_name="group-prio-config-shaper-wfq", rest_name="group-prio-config-shaper-wfq", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-qos-cpu', defining_module='brocade-qos-cpu', yang_type='container', is_config=True)
    self.__group_prio_id = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..3']}), is_leaf=True, yang_name="group-prio-id", rest_name="group-prio-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-qos-cpu', defining_module='brocade-qos-cpu', yang_type='priority', is_config=True)
  ...
  def _set_group_prio_config_shaper_wfq(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=group_prio_config_shaper_wfq.group_prio_config_shaper_wfq, is_container='container', presence=False, yang_name="group-prio-config-shaper-wfq", rest_name="group-prio-config-shaper-wfq", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-qos-cpu', defining_module='brocade-qos-cpu', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """group_prio_config_shaper_wfq must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=group_prio_config_shaper_wfq.group_prio_config_shaper_wfq, is_container='container', presence=False, yang_name="group-prio-config-shaper-wfq", rest_name="group-prio-config-shaper-wfq", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-qos-cpu', defining_module='brocade-qos-cpu', yang_type='container', is_config=True)""",
        })
