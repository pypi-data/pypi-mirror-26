...
interface
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vlan','__vlanoper','__rspan_vlan',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__rspan_vlan = YANGDynClass(base=rspan_vlan.rspan_vlan, is_container='container', presence=False, yang_name="rspan-vlan", rest_name="rspan-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
    self.__vlanoper = YANGDynClass(base=vlanoper.vlanoper, is_container='container', presence=False, yang_name="vlanoper", rest_name="vlanoper", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
...
Do not use in edit-config.
  ...
  _pyangbind_elements = {'vlan': vlan, 'vlanoper': vlanoper, 'rspan_vlan': rspan_vlan, }
