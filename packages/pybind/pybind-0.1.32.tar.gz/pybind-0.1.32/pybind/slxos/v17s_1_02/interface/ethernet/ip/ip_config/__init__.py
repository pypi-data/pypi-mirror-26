...
class ip_config(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mtu','__proxy_arp','__arp','__arp_aging_timeout','__address','__unnumbered',)
  ...
  _pyangbind_elements = {'mtu': mtu, 'proxy_arp': proxy_arp, 'arp': arp, 'arp_aging_timeout': arp_aging_timeout, 'address': address, 'unnumbered': unnumbered, }
