...
Homerun interfaces in the managed device.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__ifindex','__description','__shutdown','__channel_group','__ip','__ipv6','__vrf','__bfd','__track','__mtu','__switchport_basic','__switchport','__sflow',)
...
datagram that can be sent on the interface.
  ...
  _pyangbind_elements = {'name': name, 'ifindex': ifindex, 'description': description, 'shutdown': shutdown, 'channel_group': channel_group, 'ip': ip, 'ipv6': ipv6, 'vrf': vrf, 'bfd': bfd, 'track': track, 'mtu': mtu, 'switchport_basic': switchport_basic, 'switchport': switchport, 'sflow': sflow, }
