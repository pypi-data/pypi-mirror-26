...
class standard(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__hide_mac_acl_std = YANGDynClass(base=hide_mac_acl_std.hide_mac_acl_std, is_container='container', presence=False, yang_name="hide-mac-acl-std", rest_name="hide-mac-acl-std", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='container', is_config=True)
