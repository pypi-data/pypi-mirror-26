...
class protocol(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__hide_vrrp_holder = YANGDynClass(base=hide_vrrp_holder.hide_vrrp_holder, is_container='container', presence=False, yang_name="hide-vrrp-holder", rest_name="hide-vrrp-holder", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-vrrp', defining_module='brocade-vrrp', yang_type='container', is_config=True)
