...
class default_vrf(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__next_hop_mpls = YANGDynClass(base=next_hop_mpls.next_hop_mpls, is_container='container', presence=True, yang_name="next-hop-mpls", rest_name="next-hop-mpls", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
