...
class neighbor(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__evpn_peer_group = YANGDynClass(base=YANGListType("evpn_neighbor_peergroup_name",evpn_peer_group.evpn_peer_group, yang_name="evpn-peer-group", rest_name="evpn-peer-group", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='evpn-neighbor-peergroup-name', extensions=None), is_container='list', yang_name="evpn-peer-group", rest_name="evpn-peer-group", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='list', is_config=True)
    self.__evpn_neighbor_ipv4 = YANGDynClass(base=YANGListType("evpn_neighbor_ipv4_address",evpn_neighbor_ipv4.evpn_neighbor_ipv4, yang_name="evpn-neighbor-ipv4", rest_name="evpn-neighbor-ipv4", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='evpn-neighbor-ipv4-address', extensions=None), is_container='list', yang_name="evpn-neighbor-ipv4", rest_name="evpn-neighbor-ipv4", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='list', is_config=True)
    self.__evpn_neighbor_ipv6 = YANGDynClass(base=YANGListType("evpn_neighbor_ipv6_address",evpn_neighbor_ipv6.evpn_neighbor_ipv6, yang_name="evpn-neighbor-ipv6", rest_name="evpn-neighbor-ipv6", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='evpn-neighbor-ipv6-address', extensions=None), is_container='list', yang_name="evpn-neighbor-ipv6", rest_name="evpn-neighbor-ipv6", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='list', is_config=True)
