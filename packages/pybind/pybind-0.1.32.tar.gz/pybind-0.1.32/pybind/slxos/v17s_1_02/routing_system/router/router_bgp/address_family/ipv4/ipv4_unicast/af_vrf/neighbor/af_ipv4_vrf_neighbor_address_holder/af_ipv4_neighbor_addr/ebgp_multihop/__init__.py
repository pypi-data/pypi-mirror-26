...
class ebgp_multihop(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__ebgp_multihop_count = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..255']}), is_leaf=True, yang_name="ebgp-multihop-count", rest_name="ebgp-multihop-count", parent=self, choice=(u'ch-ebgp-multihop-type', u'ca-ebgp-multihop-count'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='uint32', is_config=True)
    self.__ebgp_multihop_flag = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="ebgp-multihop-flag", rest_name="ebgp-multihop-flag", parent=self, choice=(u'ch-ebgp-multihop-type', u'ca-ebgp-multihop-flag'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)
