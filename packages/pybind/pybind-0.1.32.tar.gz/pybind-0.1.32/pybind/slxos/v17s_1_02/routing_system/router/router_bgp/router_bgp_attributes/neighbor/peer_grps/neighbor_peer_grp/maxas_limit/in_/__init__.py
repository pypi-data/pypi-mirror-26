...
class in_(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__maxas_limit_disable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="maxas-limit-disable", rest_name="maxas-limit-disable", parent=self, choice=(u'ch-maxas-limit', u'ca-maxas-limit-disable'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)
    self.__num_as_in_as_path = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'0..300']}), is_leaf=True, yang_name="num-as-in-as-path", rest_name="num-as-in-as-path", parent=self, choice=(u'ch-maxas-limit', u'ca-maxas-limit-enable'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='num-as-in-as-path', is_config=True)
  ...
  def _set_maxas_limit_disable(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="maxas-limit-disable", rest_name="maxas-limit-disable", parent=self, choice=(u'ch-maxas-limit', u'ca-maxas-limit-disable'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """maxas_limit_disable must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="maxas-limit-disable", rest_name="maxas-limit-disable", parent=self, choice=(u'ch-maxas-limit', u'ca-maxas-limit-disable'), path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)""",
        })
