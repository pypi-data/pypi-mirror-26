...
class ipv6_static_route_oif_vrf(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__static_route_oif_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'gigabitethernet': {'value': 2}, u've': {'value': 4}, u'fortygigabitethernet': {'value': 6}, u'port-channel': {'value': 8}, u'tengigabitethernet': {'value': 1}, u'hundredgigabitethernet': {'value': 7}},), is_leaf=True, yang_name="static-route-oif-type", rest_name="static-route-oif-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ipv6-rtm', defining_module='brocade-ipv6-rtm', yang_type='enumeration', is_config=True)
