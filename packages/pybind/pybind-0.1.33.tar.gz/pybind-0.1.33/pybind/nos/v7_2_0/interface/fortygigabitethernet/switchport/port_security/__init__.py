...
class port_security(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__sticky = YANGDynClass(base=sticky.sticky, is_container='container', presence=False, yang_name="sticky", rest_name="sticky", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
