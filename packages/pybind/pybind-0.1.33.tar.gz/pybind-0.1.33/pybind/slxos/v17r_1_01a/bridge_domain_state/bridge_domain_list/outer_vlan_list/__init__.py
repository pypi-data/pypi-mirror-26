...
class outer_vlan_list(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__untagged_ports_list = YANGDynClass(base=YANGListType("lif_name",untagged_ports_list.untagged_ports_list, yang_name="untagged-ports-list", rest_name="untagged-ports-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='lif-name', extensions=None), is_container='list', yang_name="untagged-ports-list", rest_name="untagged-ports-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    self.__tagged_ports_list = YANGDynClass(base=YANGListType("lif_name",tagged_ports_list.tagged_ports_list, yang_name="tagged-ports-list", rest_name="tagged-ports-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='lif-name', extensions=None), is_container='list', yang_name="tagged-ports-list", rest_name="tagged-ports-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
