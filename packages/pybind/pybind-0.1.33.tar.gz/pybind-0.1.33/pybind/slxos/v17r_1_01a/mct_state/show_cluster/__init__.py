...
class show_cluster(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__active_vlan_list = YANGDynClass(base=YANGListType("vlan_id",active_vlan_list.active_vlan_list, yang_name="active-vlan-list", rest_name="active-vlan-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vlan-id', extensions=None), is_container='list', yang_name="active-vlan-list", rest_name="active-vlan-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    ...
    self.__bd_list = YANGDynClass(base=YANGListType("bd_id",bd_list.bd_list, yang_name="bd-list", rest_name="bd-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions=None), is_container='list', yang_name="bd-list", rest_name="bd-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    ...
    self.__peer_info_list = YANGDynClass(base=YANGListType("peer_ip_addr",peer_info_list.peer_info_list, yang_name="peer-info-list", rest_name="peer-info-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='peer-ip-addr', extensions=None), is_container='list', yang_name="peer-info-list", rest_name="peer-info-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    ...
    self.__client_info_list = YANGDynClass(base=YANGListType("cluster_id client_id",client_info_list.client_info_list, yang_name="client-info-list", rest_name="client-info-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id client-id', extensions=None), is_container='list', yang_name="client-info-list", rest_name="client-info-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    self.__active_bd_list = YANGDynClass(base=YANGListType("bd_id",active_bd_list.active_bd_list, yang_name="active-bd-list", rest_name="active-bd-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions=None), is_container='list', yang_name="active-bd-list", rest_name="active-bd-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    ...
    self.__config_vlan_list = YANGDynClass(base=YANGListType("vlan_id",config_vlan_list.config_vlan_list, yang_name="config-vlan-list", rest_name="config-vlan-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='vlan-id', extensions=None), is_container='list', yang_name="config-vlan-list", rest_name="config-vlan-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
