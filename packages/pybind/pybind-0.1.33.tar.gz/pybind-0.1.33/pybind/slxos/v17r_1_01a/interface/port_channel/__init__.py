...
following MAC learning process.
  ...
  _pyangbind_elements = {'name': name, 'vlag': vlag, 'po_speed': po_speed, 'insight': insight, 'ifindex': ifindex, 'description': description, 'shutdown': shutdown, 'minimum_links': minimum_links, 'mtu': mtu, 'route_only': route_only, 'switchport_basic': switchport_basic, 'switchport': switchport, 'ip': ip, 'ipv6': ipv6, 'track': track, 'edge_loop_detection_native': edge_loop_detection_native, 'edge_loop_detection': edge_loop_detection, 'priority_tag_enable': priority_tag_enable, 'load_balance': load_balance, 'load_balance_type': load_balance_type, 'mac': mac, 'hide_vrrp_holer': hide_vrrp_holer, 'logical_interface': logical_interface, 'fcoeport': fcoeport, 'spanning_tree': spanning_tree, 'ip_acl_interface': ip_acl_interface, 'lacp_pdu_forward': lacp_pdu_forward, 'openflowPo': openflowPo, 'port_profile_port': port_profile_port, 'port_profile_to_interface_associations': port_profile_to_interface_associations, 'qos': qos, 'service_policy': service_policy, }
