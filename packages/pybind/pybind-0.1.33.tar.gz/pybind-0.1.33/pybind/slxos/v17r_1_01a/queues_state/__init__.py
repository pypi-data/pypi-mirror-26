...
class queues_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__queue_interface_list = YANGDynClass(base=YANGListType("interface_value",queue_interface_list.queue_interface_list, yang_name="queue-interface-list", rest_name="queue-interface-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-value', extensions=None), is_container='list', yang_name="queue-interface-list", rest_name="queue-interface-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=False)
