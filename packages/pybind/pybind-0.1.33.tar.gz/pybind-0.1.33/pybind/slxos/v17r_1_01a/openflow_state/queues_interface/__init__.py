...
class queues_interface(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__queue_info_list = YANGDynClass(base=YANGListType("interface num",queue_info_list.queue_info_list, yang_name="queue-info-list", rest_name="queue-info-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface num', extensions=None), is_container='list', yang_name="queue-info-list", rest_name="queue-info-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=False)
