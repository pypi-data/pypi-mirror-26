...
class meter_id(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__meterband_info_list = YANGDynClass(base=YANGListType("band_type",meterband_info_list.meterband_info_list, yang_name="meterband-info-list", rest_name="meterband-info-list", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='band-type', extensions=None), is_container='list', yang_name="meterband-info-list", rest_name="meterband-info-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=False)
