...
class mem_list(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__memory_per_process = YANGDynClass(base=YANGListType("memory_process_id",memory_per_process.memory_per_process, yang_name="memory-per-process", rest_name="memory-per-process", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='memory-process-id', extensions=None), is_container='list', yang_name="memory-per-process", rest_name="memory-per-process", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-RAS-operational', defining_module='brocade-RAS-operational', yang_type='list', is_config=False)
