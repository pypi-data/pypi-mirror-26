...
class adj_neighbor(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__adj_area = YANGDynClass(base=YANGListType("adj_asi_area_name",adj_area.adj_area, yang_name="adj-area", rest_name="adj-area", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='adj-asi-area-name', extensions=None), is_container='list', yang_name="adj-area", rest_name="adj-area", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='list', is_config=False)
