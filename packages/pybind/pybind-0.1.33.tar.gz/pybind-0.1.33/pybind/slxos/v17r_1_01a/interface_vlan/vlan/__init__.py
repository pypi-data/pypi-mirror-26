...
to this list.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__statistics','__loop_detection','__router_interface','__ifindex','__description','__vlan_name','__ip','__ipv6','__mac','__spanning_tree','__remote_span',)
  ...
  _pyangbind_elements = {'name': name, 'statistics': statistics, 'loop_detection': loop_detection, 'router_interface': router_interface, 'ifindex': ifindex, 'description': description, 'vlan_name': vlan_name, 'ip': ip, 'ipv6': ipv6, 'mac': mac, 'spanning_tree': spanning_tree, 'remote_span': remote_span, }
