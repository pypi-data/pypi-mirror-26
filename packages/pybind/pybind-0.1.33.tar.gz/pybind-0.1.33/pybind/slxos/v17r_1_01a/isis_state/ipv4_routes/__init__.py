...
class ipv4_routes(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ipv4_route_entry = YANGDynClass(base=YANGListType("ipv4_dest_addr ipv4_subnet_mask ipv4_prefix_len",ipv4_route_entry.ipv4_route_entry, yang_name="ipv4-route-entry", rest_name="ipv4-route-entry", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='ipv4-dest-addr ipv4-subnet-mask ipv4-prefix-len', extensions=None), is_container='list', yang_name="ipv4-route-entry", rest_name="ipv4-route-entry", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='list', is_config=False)
