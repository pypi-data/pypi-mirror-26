...
class isis_system_info(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__nsap = YANGDynClass(base=YANGListType("net_addr",nsap.nsap, yang_name="nsap", rest_name="nsap", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='net-addr', extensions=None), is_container='list', yang_name="nsap", rest_name="nsap", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='list', is_config=False)
