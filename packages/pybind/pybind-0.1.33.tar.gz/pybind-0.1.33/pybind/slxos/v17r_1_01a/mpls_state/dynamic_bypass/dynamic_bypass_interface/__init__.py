...
class dynamic_bypass_interface(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__mp_infos = YANGDynClass(base=YANGListType("router_id",mp_infos.mp_infos, yang_name="mp-infos", rest_name="mp-infos", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='router-id', extensions=None), is_container='list', yang_name="mp-infos", rest_name="mp-infos", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
