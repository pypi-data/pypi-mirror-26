...
class area(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__node = YANGDynClass(base=YANGListType("local_node_id local_router_id",node.node, yang_name="node", rest_name="node", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='local-node-id local-router-id', extensions=None), is_container='list', yang_name="node", rest_name="node", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
