...
class lsp(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__cspf_hop = YANGDynClass(base=YANGListType("index",cspf_hop.cspf_hop, yang_name="cspf-hop", rest_name="cspf-hop", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='index', extensions=None), is_container='list', yang_name="cspf-hop", rest_name="cspf-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
    ...
    self.__rro_hop = YANGDynClass(base=YANGListType("index",rro_hop.rro_hop, yang_name="rro-hop", rest_name="rro-hop", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='index', extensions=None), is_container='list', yang_name="rro-hop", rest_name="rro-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
