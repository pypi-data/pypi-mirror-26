...
class protocol_errors(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__protocol_error = YANGDynClass(base=YANGListType("error_type",protocol_error.protocol_error, yang_name="protocol-error", rest_name="protocol-error", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='error-type', extensions=None), is_container='list', yang_name="protocol-error", rest_name="protocol-error", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
