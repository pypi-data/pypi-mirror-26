...
class interfaces(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__error_counters = YANGDynClass(base=error_counters.error_counters, is_container='container', presence=False, yang_name="error-counters", rest_name="error-counters", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='container', is_config=False)
