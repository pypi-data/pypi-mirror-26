...
class interface_refresh_reduction(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__summary_refresh','__bundle_message','__rsvp_refresh_reduction_disable',)

  _yang_name = 'interface-refresh-reduction'
  _rest_name = 'interface-refresh-reduction'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__rsvp_refresh_reduction_disable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="rsvp-refresh-reduction-disable", rest_name="rsvp-refresh-reduction-disable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='empty', is_config=True)
  ...
  def _set_rsvp_refresh_reduction_disable(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="rsvp-refresh-reduction-disable", rest_name="rsvp-refresh-reduction-disable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """rsvp_refresh_reduction_disable must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="rsvp-refresh-reduction-disable", rest_name="rsvp-refresh-reduction-disable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='empty', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'summary_refresh': summary_refresh, 'bundle_message': bundle_message, 'rsvp_refresh_reduction_disable': rsvp_refresh_reduction_disable, }
