...
class ip(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__pim_intf_vlan_cont = YANGDynClass(base=pim_intf_vlan_cont.pim_intf_vlan_cont, is_container='container', presence=False, yang_name="pim-intf-vlan-cont", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'PimVlanIntfCallpoint', u'sort-priority': u'RUNNCFG_INTERFACE_LEVEL_L3_PIM_CONFIG'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='container', is_config=True)
