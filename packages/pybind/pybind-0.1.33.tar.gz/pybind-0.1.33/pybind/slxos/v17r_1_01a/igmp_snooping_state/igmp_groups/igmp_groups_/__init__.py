...
class igmp_groups(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__igmpv3_sources = YANGDynClass(base=YANGListType("interface_name",igmpv3_sources.igmpv3_sources, yang_name="igmpv3-sources", rest_name="igmpv3-sources", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-name', extensions=None), is_container='list', yang_name="igmpv3-sources", rest_name="igmpv3-sources", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=False)
