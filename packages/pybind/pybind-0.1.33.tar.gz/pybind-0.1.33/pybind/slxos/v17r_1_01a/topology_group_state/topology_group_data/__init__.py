...
class topology_group_data(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__member_bd = YANGDynClass(base=YANGListType("bd_id",member_bd.member_bd, yang_name="member-bd", rest_name="member-bd", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions=None), is_container='list', yang_name="member-bd", rest_name="member-bd", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    ...
    self.__master_vlan = YANGDynClass(base=master_vlan.master_vlan, is_container='container', presence=False, yang_name="master-vlan", rest_name="master-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=False)
