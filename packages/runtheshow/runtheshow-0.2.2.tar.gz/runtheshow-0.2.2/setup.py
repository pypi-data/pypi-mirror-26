...
about = {}
with io.open(os.path.join(here, 'runtheshow', '__version__.py')) as f:
    exec(f.read(), about)
...
setup(
    ...
    install_requires=['twine', 'keyring', 'requests', 'lxml', 'cssselect'],
    ...
    entry_points=dict(console_scripts=['runtheshow=runtheshow:cli']),
