...
# Ugly hack so that the SimpleDoc class is picklable using the pickle module on Python 2
# (see https://stackoverflow.com/questions/1947904/how-can-i-pickle-a-nested-class-in-python )

Tag = SimpleDoc.Tag
DocumentRoot = SimpleDoc.DocumentRoot
