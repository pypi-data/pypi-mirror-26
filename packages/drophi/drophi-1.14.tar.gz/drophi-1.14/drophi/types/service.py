...
class Endpoint():
    ...
    def __init__(self, ports, mode='vip', virtual_ips=None):
        self.mode        = mode
        self.ports       = ports
...
class Service():
    ...
    def __init__(self, name, image, endpoint=None, environment=None, data=None, id_=None, previous=None, version=None, command=None, configs=None, constraints=None, log_name=None, log_options=None, mounts=None, networks=None, secrets=None):
