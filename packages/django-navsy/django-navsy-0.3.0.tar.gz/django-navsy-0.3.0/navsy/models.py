...
class Page(NodeModel):
    ...
    sitemap_priority = models.CharField(max_length=5, choices=SITEMAP_PRIORITY_CHOICES)
    sitemap_changefreq = models.CharField(max_length=50, choices=SITEMAP_CHANGEFREQ_CHOICES)
