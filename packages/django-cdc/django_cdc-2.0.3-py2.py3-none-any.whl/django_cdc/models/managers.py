...
if local_settings.ENABLE_KOMBU_SERIALIZATION:
    try:
        from kombu.serialization import registry, unpickle, pickle_protocol
    except:
        local_settings.ENABLE_KOMBU_SERIALIZATION = False
        logger.warning("kombu module not installed, "
                       "disabling kombu serialization")
...
class DjangoCDC(object):
    ...
    def finalize(self, sender, **kwargs):
        ...
        descriptor = DjangoCDCDescriptor(
            ...
            self._exclude, self.foreign_keys, self.services, self.partition_key)
