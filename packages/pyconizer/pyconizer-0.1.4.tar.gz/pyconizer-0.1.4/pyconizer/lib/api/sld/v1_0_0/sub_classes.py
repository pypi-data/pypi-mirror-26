...
class StyledLayerDescriptorSub(supermod.StyledLayerDescriptor):
    def __init__(self, version=None, Name=None, Title=None, Abstract=None, NamedLayer=None, UserLayer=None):
        super(StyledLayerDescriptorSub, self).__init__(version, Name, Title, Abstract, NamedLayer,
                                                       UserLayer, )
...
class FeatureTypeStyleSub(supermod.FeatureTypeStyle):
    def __init__(self, Name=None, Title=None, Abstract=None, FeatureTypeName=None,
        ...
        super(FeatureTypeStyleSub, self).__init__(Name, Title, Abstract, FeatureTypeName,
                                                  SemanticTypeIdentifier, Rule, )
...
class RuleSub(supermod.Rule):
    def __init__(self, Name=None, Title=None, Abstract=None, LegendGraphic=None, Filter=None, ElseFilter=None,
        ...
        super(RuleSub, self).__init__(Name, Title, Abstract, LegendGraphic, Filter, ElseFilter,
                                      MinScaleDenominator, MaxScaleDenominator, Symbolizer, )
...
class ParameterValueTypeSub(supermod.ParameterValueType):
    def __init__(self, expression=None, valueOf_=None, mixedclass_=None, content_=None, extensiontype_=None):
        super(ParameterValueTypeSub, self).__init__(expression, valueOf_, mixedclass_, content_,
                                                    extensiontype_, )
...
class RasterSymbolizerSub(supermod.RasterSymbolizer):
    def __init__(self, Geometry=None, Opacity=None, ChannelSelection=None, OverlapBehavior=None,
        ...
        super(RasterSymbolizerSub, self).__init__(Geometry, Opacity, ChannelSelection, OverlapBehavior,
...
class simpleSub(supermod.simple):
    def __init__(self, type_=None, href=None, role=None, arcrole=None, title=None, show=None, actuate=None,
        ...
        super(simpleSub, self).__init__(type_, href, role, arcrole, title, show, actuate, anytypeobjs_,
                                        valueOf_, mixedclass_, content_, )
...
class resourceTypeSub(supermod.resourceType):
    def __init__(self, type_=None, role=None, title=None, label=None, anytypeobjs_=None, valueOf_=None,
        ...
        super(resourceTypeSub, self).__init__(type_, role, title, label, anytypeobjs_, valueOf_, mixedclass_,
                                              content_, )
...
class GeometryAssociationTypeSub(supermod.GeometryAssociationType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(GeometryAssociationTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title,
                                                         show, actuate, _Geometry, )
...
class PointMemberTypeSub(supermod.PointMemberType):
    def __init__(self, type_=None, href=None, role=None, arcrole=None, title=None, show=None, actuate=None,
        ...
        super(PointMemberTypeSub, self).__init__(type_, href, role, arcrole, title, show, actuate,
                                                 remoteSchema, Point, )
...
class LineStringMemberTypeSub(supermod.LineStringMemberType):
    def __init__(self, type_=None, href=None, role=None, arcrole=None, title=None, show=None, actuate=None,
        ...
        super(LineStringMemberTypeSub, self).__init__(type_, href, role, arcrole, title, show, actuate,
                                                      remoteSchema, LineString, )
...
class PolygonMemberTypeSub(supermod.PolygonMemberType):
    def __init__(self, type_=None, href=None, role=None, arcrole=None, title=None, show=None, actuate=None,
        ...
        super(PolygonMemberTypeSub, self).__init__(type_, href, role, arcrole, title, show, actuate,
                                                   remoteSchema, Polygon, )
...
class LinearRingMemberTypeSub(supermod.LinearRingMemberType):
    def __init__(self, type_=None, href=None, role=None, arcrole=None, title=None, show=None, actuate=None,
        ...
        super(LinearRingMemberTypeSub, self).__init__(type_, href, role, arcrole, title, show, actuate,
                                                      remoteSchema, LinearRing, )
...
class AbstractFeatureCollectionTypeSub(supermod.AbstractFeatureCollectionType):
    def __init__(self, fid=None, description=None, name=None, boundedBy=None, featureMember=None):
        super(AbstractFeatureCollectionTypeSub, self).__init__(fid, description, name, boundedBy,
                                                               featureMember, )
...
class GeometryPropertyTypeSub(supermod.GeometryPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
                 show=None, actuate=None, _Geometry=None):
        super(GeometryPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title, show,
                                                      actuate, _Geometry, )
...
class FeatureAssociationTypeSub(supermod.FeatureAssociationType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(FeatureAssociationTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title, show,
                                                        actuate, _Feature, )
...
class PointPropertyTypeSub(supermod.PointPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(PointPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title, show,
                                                   actuate, Point, )
...
class PolygonPropertyTypeSub(supermod.PolygonPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(PolygonPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title, show,
                                                     actuate, Polygon, )
...
class LineStringPropertyTypeSub(supermod.LineStringPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(LineStringPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title, show,
                                                        actuate, LineString, )
...
class MultiPointPropertyTypeSub(supermod.MultiPointPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(MultiPointPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title, show,
                                                        actuate, MultiPoint, )
...
class MultiLineStringPropertyTypeSub(supermod.MultiLineStringPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(MultiLineStringPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title,
                                                             show, actuate, MultiLineString, )
...
class MultiPolygonPropertyTypeSub(supermod.MultiPolygonPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(MultiPolygonPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title,
                                                          show, actuate, MultiPolygon, )
...
class MultiGeometryPropertyTypeSub(supermod.MultiGeometryPropertyType):
    def __init__(self, remoteSchema=None, type_=None, href=None, role=None, arcrole=None, title=None,
        ...
        super(MultiGeometryPropertyTypeSub, self).__init__(remoteSchema, type_, href, role, arcrole, title,
                                                           show, actuate, MultiGeometry, )
