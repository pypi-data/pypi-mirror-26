...
def load_salt_info(data_file_name):
    ...
    data : Pandas DataFrame
        A data frame with each row representing one salt and each column
        representing the features of a given salt.
    """
    module_path = dirname(__file__)
    with open(join(module_path, 'data', data_file_name)) as csv_file:
        data_file = pd.read_csv(csv_file.read())
