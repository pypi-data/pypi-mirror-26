...
class ChromeBoy:
    ...
    def new_page(self, **kwargs):
        ...
        try:
            ...
            print(e, type(e), 'error when getting result from response')
        ...
        if result is None or not result.get('value') or result_except_flag:
            ...
            try:
                ...
                print(e, type(e), 'error when getting result from response again')
                result = {'value': {}}
        r = result['value']
        r = json.loads(r)
    ...
    def chrome(self):
        self.browser = websocket.create_connection(self._browser_url,  # + '/9d220c5c-7eba-4927-a95c-dfd56c689779',
