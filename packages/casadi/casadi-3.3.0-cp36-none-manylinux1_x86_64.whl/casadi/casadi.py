...
class IM(MatrixCommon, GenericExpressionCommon, GenIM, PrintableCommon):
    ...
    def from_info(*args) -> "casadi::Matrix< int >":
        """
...
def IM_from_info(*args) -> "casadi::Matrix< int >":
    """
...
class Function(SharedObject, PrintableCommon):
    ...
    def instruction_input(self, *args) -> "std::vector< int,std::allocator< int > >":
        """
    ...
    def instruction_output(self, *args) -> "std::vector< int,std::allocator< int > >":
        """
...
def qr_sparse(*args) -> "casadi::Matrix< casadi::SXElem > &, casadi::Matrix< casadi::SXElem > &, casadi::Matrix< casadi::SXElem > &, std::vector< int > &":
    """
...
def ldl(*args) -> "casadi::Matrix< casadi::SXElem > &, casadi::Matrix< casadi::SXElem > &":
    """
...
def GlobalOptions_getMaxNumDir(*args) -> "int":
    """
