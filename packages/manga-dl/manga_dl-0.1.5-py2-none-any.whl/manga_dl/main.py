...
def main():
    ...
    try:
        ...
        parser.add_argument(u"-t", u"--threads", type=int,
                            default=multiprocessing.cpu_count())
        parser.add_argument(u"-v", u"--verbose", action=u"store_true",
                            default=False)
        parser.add_argument(u"--zip_chapters", action=u"store_true",
                            default=False)
        parser.add_argument(u"--zip_volumes", action=u"store_true",
                            default=False)
        ...
        if args.url:
            ...
            destination = \
                os.path.join(os.getcwdu(), series_name) if not args.destination\
            ...
            print u"No valid argument combination supplied. "
                u"See --help for more details"
