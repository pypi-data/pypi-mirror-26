...
about = {}
with io.open(os.path.join(here, 'emissionrpc', '__version__.py')) as f:
    exec(f.read(), about)
...
setup(
    ...
    install_requires=['twine', 'keyring'],
    ...
    #entry_points=dict(console_scripts=['emission = emission:cli']),
