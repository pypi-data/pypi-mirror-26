...
class NiceCXNetwork(object):
    ...
    def add_node(self, node_element=None, id=None, node_name=None, node_represents=None, json_obj=None):
        if node_element is None:
            node_element = NodeElement(id=id, node_name=node_name, node_represents=node_represents, json_obj=json_obj)
    ...
    def add_edge(self, edge_element=None, id=None, edge_source=None, edge_target=None, edge_interaction=None, json_obj=None):
        if edge_element is None:
            edge_element = EdgeElement(id=id, edge_source=edge_source, edge_target=edge_target, edge_interaction=edge_interaction, json_obj=json_obj)
    ...
    def get_edge_attribute(self, edge, attr_name):
