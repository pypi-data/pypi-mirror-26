$ociTopLevelCommands = @(
    'audit', 'bv', 'compute', 'db', 'iam', 'network', 'os', 'setup'
)
...
$ociSubcommands = @{
    ...
    'db database' = 'create delete get list patch restore update'
    ...
    'os object' = 'bulk-delete bulk-download bulk-upload delete get head list put rename restore resume-put'
...
$ociCommandsToLongParams = @{
    'audit config get' = 'compartment-id from-json generate-full-command-json-input generate-param-json-input help'
    'audit config update' = 'compartment-id from-json generate-full-command-json-input generate-param-json-input help retention-period-days'
    'audit event list' = 'all compartment-id end-time from-json generate-full-command-json-input generate-param-json-input help opc-request-id page start-time'
    ...
    'bv backup list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order volume-id'
    ...
    'bv volume create' = 'availability-domain compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help size-in-gbs size-in-mbs source-volume-id volume-backup-id'
    ...
    'bv volume list' = 'all availability-domain compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order'
    ...
    'compute console-history list' = 'all availability-domain compartment-id from-json generate-full-command-json-input generate-param-json-input help instance-id lifecycle-state limit page page-size sort-by sort-order'
    ...
    'compute image list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit operating-system operating-system-version page page-size sort-by sort-order'
    ...
    'compute instance list' = 'all availability-domain compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order'
    'compute instance list-vnics' = 'all from-json generate-full-command-json-input generate-param-json-input help instance-id limit page page-size'
    ...
    'compute instance-console-connection list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help instance-id limit page page-size'
    'compute shape list' = 'all availability-domain compartment-id from-json generate-full-command-json-input generate-param-json-input help image-id limit page page-size'
    'compute vnic-attachment get' = 'from-json generate-full-command-json-input generate-param-json-input help vnic-attachment-id'
    'compute vnic-attachment list' = 'all availability-domain compartment-id from-json generate-full-command-json-input generate-param-json-input help instance-id limit page page-size vnic-id'
    ...
    'compute volume-attachment list' = 'all availability-domain compartment-id from-json generate-full-command-json-input generate-param-json-input help instance-id limit page page-size volume-id'
    'db backup create' = 'database-id display-name from-json generate-full-command-json-input generate-param-json-input help'
    'db backup delete' = 'backup-id force from-json generate-full-command-json-input generate-param-json-input help if-match'
    'db backup get' = 'backup-id from-json generate-full-command-json-input generate-param-json-input help'
    'db backup list' = 'all compartment-id database-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'db data-guard-association list' = 'all database-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'db database patch' = 'database-id from-json generate-full-command-json-input generate-param-json-input help patch-action patch-id'
    'db database restore' = 'database-id database-scn from-json generate-full-command-json-input generate-param-json-input help if-match latest timestamp'
    'db database update' = 'auto-backup-enabled database-id force from-json generate-full-command-json-input generate-param-json-input help if-match'
    'db node get' = 'db-node-id from-json generate-full-command-json-input generate-param-json-input help'
    'db node list' = 'all compartment-id db-system-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'db patch get by-database' = 'database-id from-json generate-full-command-json-input generate-param-json-input help patch-id'
    'db patch get by-db-system' = 'db-system-id from-json generate-full-command-json-input generate-param-json-input help patch-id'
    'db patch list by-database' = 'all database-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    'db patch list by-db-system' = 'all db-system-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    'db patch-history get by-database' = 'database-id from-json generate-full-command-json-input generate-param-json-input help patch-history-entry-id'
    'db patch-history get by-db-system' = 'db-system-id from-json generate-full-command-json-input generate-param-json-input help patch-history-entry-id'
    'db patch-history list by-database' = 'all database-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    'db patch-history list by-db-system' = 'all db-system-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'db system list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    'db system patch' = 'db-system-id from-json generate-full-command-json-input generate-param-json-input help patch-action patch-id'
    ...
    'db system update' = 'cpu-core-count data-storage-size-in-gbs db-system-id force from-json generate-full-command-json-input generate-param-json-input help if-match patch-action patch-id ssh-authorized-keys-file'
    'db system-shape list' = 'all availability-domain compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    'db version list' = 'all compartment-id db-system-shape from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'iam compartment list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'iam group list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    'iam group list-users' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input group-id help limit page page-size'
    ...
    'iam policy list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'iam user list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    'iam user list-groups' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size user-id'
    ...
    'network cpe list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'network dhcp-options list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order vcn-id'
    ...
    'network drg list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'network drg-attachment list' = 'all compartment-id drg-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size vcn-id'
    ...
    'network internet-gateway list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order vcn-id'
    ...
    'network ip-sec-connection list' = 'all compartment-id cpe-id drg-id from-json generate-full-command-json-input generate-param-json-input help limit page page-size'
    ...
    'network private-ip list' = 'all from-json generate-full-command-json-input generate-param-json-input help ip-address limit page page-size subnet-id vnic-id'
    ...
    'network route-table list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order vcn-id'
    ...
    'network security-list list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order vcn-id'
    ...
    'network subnet list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order vcn-id'
    ...
    'network vcn list' = 'all compartment-id display-name from-json generate-full-command-json-input generate-param-json-input help lifecycle-state limit page page-size sort-by sort-order'
    ...
    'os bucket create' = 'compartment-id from-json generate-full-command-json-input generate-param-json-input help metadata name namespace public-access-type storage-tier'
    ...
    'os bucket list' = 'all compartment-id from-json generate-full-command-json-input generate-param-json-input help limit namespace page page-size'
    ...
    'os ns get-metadata' = 'from-json generate-full-command-json-input generate-param-json-input help namespace opc-client-request-id'
    'os ns update-metadata' = 'default-s3-compartment-id default-swift-compartment-id from-json generate-full-command-json-input generate-param-json-input help namespace opc-client-request-id'
    ...
    'os object bulk-download' = 'bucket-name delimiter download-dir exclude from-json generate-full-command-json-input generate-param-json-input help include multipart-download-threshold namespace no-overwrite overwrite parallel-operations-count part-size prefix'
    ...
    'os object get' = 'bucket-name file from-json generate-full-command-json-input generate-param-json-input help if-match if-none-match multipart-download-threshold name namespace parallel-download-count part-size range'
    ...
    'os object list' = 'all bucket-name delimiter end fields from-json generate-full-command-json-input generate-param-json-input help limit namespace page-size prefix start'
    ...
    'os object rename' = 'bucket from-json generate-full-command-json-input generate-param-json-input help name namespace new-if-match new-if-none-match new-name opc-client-request-id src-if-match'
    'os object restore' = 'bucket from-json generate-full-command-json-input generate-param-json-input help name namespace opc-client-request-id'
    ...
    'os preauth-request list' = 'all bucket-name from-json generate-full-command-json-input generate-param-json-input help limit namespace object-name-prefix opc-client-request-id page page-size'
