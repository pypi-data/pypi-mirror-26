...
class File:
    ...
    def list(self, *args):
        ...
        result = requests.post(('https://easyapi.io/api/v1/files/list'), data=post_fields, headers=headers)
        if (result.status_code == 200):
            return result.json()
        else:
            return { 'statusCode': result.status_code, 'success': False, 'message': 'Status error.' }
    ...
    def get(self, fileId):
        ...
        result = requests.post(('https://easyapi.io/api/v1/files/get'), data=post_fields, headers=headers)
        if (result.status_code == 200):
            return result.json()
        else:
            return { 'statusCode': result.status_code, 'success': False, 'message': 'Status error.' }
    ...
    def requestKey(self, fileId):
        headers = { 'Content-type': 'application/json', 'Authorization': self.apiKey }
        post_fields = { 'app': self.appId, 'fileId': fileId }
        result = requests.post(('https://easyapi.io/api/v1/files/request/key'), data=post_fields, headers=headers)
        if (result.status_code == 200):
            return result.json()
        else:
            return { 'statusCode': result.status_code, 'success': False, 'message': 'Status error.' }
    ...
    def delete(self, fileId):
        headers = { 'Content-type': 'application/json', 'Authorization': self.apiKey }
        post_fields = { 'app': self.appId, 'fileId': fileId }
        result = requests.post(('https://easyapi.io/api/v1/files/delete'), data=post_fields, headers=headers)
        if (result.status_code == 200):
            return result.json()
        else:
            return { 'statusCode': result.status_code, 'success': False, 'message': 'Status error.' }
    ...
    def getFileBody(self, fileId, requestKey, download):
        ...
        result = requests.post(('https://easyapi.io/api/v1/files/body'), data=post_fields, headers=headers)
        if (result.status_code == 200):
            return result.json()
        else:
            return { 'statusCode': result.status_code, 'success': False, 'message': 'Status error.' }
