...
from .._util import get_current_model_management_account
        ...
        try:
            ...
            if status_code >= 400 and status_code < 500:
                ...
                raise CLIError('Error occurred\n'
                               'StatusCode: {}\n'
                               'Error Message: {}\n'
                               'Run \'az ml service logs realtime -i {}\' to view more logs'.format(status_code,
                                                                                                    error_message,
                                                                                                    service_id))
                ...
                raise CLIError('Error occurred\n'
                               ...
                               '    MMA ID: {}\n'
                               '    Service ID: {}\n'
                               '    Request ID: {}'.format(status_code, error_message, sub_id, mma_id, service_id, request_id))
        except CLIError as e:
            raise e
        except Exception:
            raise CLIError('Error occurred:\n{}'.format(async_response))
    else:
