...
% remove In[]
((* block input scoped *))
   ((( custom_add_prompt(cell.source | wrap_text(88) | highlight_code(strip_verbatim=True), cell, '> ', 'incolor') )))
((* endblock input *))

% Display stream ouput with coloring
((* block stream *))
    \begin{Verbatim}[commandchars=\\\{\},fontsize=\footnotesize]
((( output.text | truncate(300, False, '\n...') | wrap_text(88) | escape_latex | ansi2latex )))
    \end{Verbatim}
((* endblock stream *))
