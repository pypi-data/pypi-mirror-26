...
setup(
    ...
    scripts=["bin/evrm"],
    packages=['evrm', ],
    long_description='''"After 17 to 27 months of treatment, both haloperidol- and olanzapine-treated monkeys had an equivalent and highly significant 8% to 11% decrease in fresh brain weight and volume when compared with the sham group.", zie (1)
...
Gif toedienen is dodelijk, doordat de patient potentieel dodelijke lichamelijke aandoeninngen kan op doen.
Bijvoorbeeld clozapine kent de volgende potentieel dodelijke aandoeningen, zie (1):
...
Los van bijwerkingen die dodelijk kunnen zijn, kan dit medicijn ook in dodelijk hoeveelheid toegediend worden. 
...
1) een lijst te maken van alle medicijnen die gif blijken te zijn en deze van de geneesmiddelnmarkt halen.
2) gif toedienende artsen door het Openbaar Ministerie laten vervolgen.
3) voor de GGZ patient de vervolging doen.
...
2) https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3476840/
