#!/usr/bin/env python
# -*- coding: UTF-8 -*-
# Time-stamp: <2017-11-06 20:52:00 Hongbo Liu>
'''
...
#         Methyentropy=NewEntropy.Entropy()
    ...
    def runDeNovo(self,UserArgslist,MethyData,ProjectName,MissReplace,AvailableGroup,MSthreshold,EDthreshold,SMthreshold,CDthreshold,SCthreshold,SLthreshold,p_DMR,p_MethylMark,OutFolder):
    ...
    def runDMROI(self,UserArgslist,MethyData,ProjectName,MissReplace,AvailableGroup,GenomeRegions,MSthreshold,EDthreshold,SMthreshold,CDthreshold,SCthreshold,SLthreshold,p_DMR,p_MethylMark,OutFolder):
...
if __name__ == '__main__':
    ...
    OutFolder="/Users/hongbo.liu/Desktop/SMART20171106_PM0.000001/"
    
    Function=DeNovoDMR_Calling()
    MethyData=MethyDataFolderName
    Function.runDeNovo(UserArgslist,MethyData,ProjectName,MissReplace,AvailableGroup,MSthreshold,EDthreshold,SMthreshold,CDthreshold,SCthreshold,SLthreshold,p_DMR,p_MethylMark,OutFolder)
