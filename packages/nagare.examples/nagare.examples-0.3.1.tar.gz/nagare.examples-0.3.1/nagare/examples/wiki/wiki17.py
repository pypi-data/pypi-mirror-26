...
from nagare import component, presentation, security, wsgi, editor, database
from nagare.database import query
...
def render(self, h, comp, *args):
    ...
    h << h.br
    h << 'You can return to the ' << h.a('FrontPage', href='page/FrontPage').action(comp.answer, u'FrontPage')
...
def populate():
    ...
    page = Page(
        u'WikiWiki', u'On this *WikiWiki*, the page contents can be '
