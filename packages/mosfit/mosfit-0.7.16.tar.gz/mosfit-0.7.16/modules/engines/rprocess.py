...
class RProcess(Engine):
    ...
    def __init__(self, **kwargs):
        ...
        self.therm_func_a = interpolate.interp2d(barnes_M,barnes_v,barnes_a)
        self.therm_func_b = interpolate.interp2d(barnes_M,barnes_v,barnes_b)
        self.therm_func_d = interpolate.interp2d(barnes_M,barnes_v,barnes_d)
    ...
    def process(self, **kwargs):
        ...
        luminosities = [0.0 if x is None or isnan(
            x) else x for x in luminosities]
