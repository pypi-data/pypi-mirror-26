...
BASE_BITSTAMP_URL = {1: 'https://www.bitstamp.net/api/',
...
class BaseClient(object):
  ...
  def _request(self, func, url, version=1, *args, **kwargs):
    ...
    url = BASE_BITSTAMP_URL[version] + url
...
class Bitstamp(BaseClient):

  def __init__(self, username=None, key=None, secret=None, *args, **kwargs):
    '''
  ...
  def _default_data(self, *args, **kwargs):
    ...
    '''
    data = super(Bitstamp, self)._default_data(*args, **kwargs)
    data['key'] = self.key
