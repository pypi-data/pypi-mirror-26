...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmnetworkgetcomponentkeyoffset_ DMNETWORKGETCOMPONENTKEYOFFSET
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmnetworkgetcomponentkeyoffset_ dmnetworkgetcomponentkeyoffset
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void PETSC_STDCALL  dmnetworkgetcomponentkeyoffset_(DM dm,PetscInt *p,PetscInt *compnum,PetscInt *compkey,PetscInt *offset, int *__ierr){
*__ierr = DMNetworkGetComponentKeyOffset(
