...
def get_version():
    """ Parses the flask_pysnow.py file and fetches the version attribute from the syntax tree
    :return: flask-pysnow version
    """
    with io.open('flask_pysnow.py') as input_file:
