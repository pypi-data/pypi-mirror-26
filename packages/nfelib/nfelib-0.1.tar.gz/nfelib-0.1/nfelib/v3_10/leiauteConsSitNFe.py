...
#
# Generated Thu Nov  2 13:10:57 2017 by generateDS.py version 2.28b.
# Python 3.5.2 (default, Sep 14 2017, 22:51:06)  [GCC 5.4.0 20160609]
#
# Command line options:
#   ('-o', 'nfelib/v3_10/leiauteConsSitNFe.py')
#
# Command line arguments:
#   schemas/v3_10/leiauteConsSitNFe_v3.10.xsd
#
# Command line:
#   /home/rvalyi/DEV/generateds/generateDS.py -o "nfelib/v3_10/leiauteConsSitNFe.py" schemas/v3_10/leiauteConsSitNFe_v3.10.xsd
#
...
SimpleTypes = {
    ...
    "cOrgao": """Tipo Código de orgão (UF da tabela do IBGE + 90 RFB)""",
    "chNFe": """Tipo Chave da Nota Fiscal Eletrônica""",
    "CNPJ": """Tipo Número do CNPJ Opcional""",
    "xMotivo": """Tipo Motivo""",
    "CPF": """Tipo Número do CPF""",
    "CPFDest": """Tipo Número do CPF""",
    "emailDest": """email do destinatário""",
    ...
    "dhRegEvento": """Data e Hora, formato UTC (AAAA-MM-DDThh:mm:ssTZD, onde TZD = +hh:mm ou -hh:mm)""",
    ...
    "dhEvento": """Data e Hora, formato UTC (AAAA-MM-DDThh:mm:ssTZD, onde TZD = +hh:mm ou -hh:mm)""",
    "CNPJDest": """Tipo Número do CNPJ Opcional""",
    "cUF": """Tipo Código da UF da tabela do IBGE""",
    "verEvento": """Versão do Tipo do Evento""",
}
...
class TConsSitNFe(GeneratedsSuper):
    ...
    def validate_TVerConsSitNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not enumeration_respectee:
                warnings_.warn(
                    'Value "%(value)s" does not match xsd enumeration restriction on TVerConsSitNFe' % {
        "value": value.encode("utf-8")})
    ...
    def export(self, outfile, level, namespace_='',
               name_='TConsSitNFe', namespacedef_='', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='',
                       name_='TConsSitNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_TVerConsSitNFe(
                self.versao)    # validate type TVerConsSitNFe
...
class TRetConsSitNFe(GeneratedsSuper):
    ...
    def __init__(self, versao=None, tpAmb=None, verAplic=None, cStat=None, xMotivo=None,
                 cUF=None, dhRecbto=None, chNFe=None, protNFe=None, retCancNFe=None, procEventoNFe=None):
        self.original_tagname_ = None
        self.versao = _cast(None, versao)
        self.tpAmb = tpAmb
        self.validate_TAmb(self.tpAmb)
    ...
    def get_retCancNFe(self): return self.retCancNFe

    def set_retCancNFe(self, retCancNFe): self.retCancNFe = retCancNFe

    def get_procEventoNFe(self): return self.procEventoNFe

    def set_procEventoNFe(
        self, procEventoNFe): self.procEventoNFe = procEventoNFe

    def add_procEventoNFe(self, value): self.procEventoNFe.append(value)

    def insert_procEventoNFe_at(
        self, index, value): self.procEventoNFe.insert(
        index, value)

    def replace_procEventoNFe_at(
        self, index, value): self.procEventoNFe[index] = value
    ...
    def export(self, outfile, level, namespace_='',
               name_='TRetConsSitNFe', namespacedef_='', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='TRetConsSitNFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='',
                       name_='TRetConsSitNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TProtNFe(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='TProtNFe',
    ...
    def exportAttributes(self, outfile, level,
                         already_processed, namespace_='', name_='TProtNFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))
...
class TRetCancNFe(GeneratedsSuper):
    ...
    def validate_TVerCancNFe(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_TVerCancNFe_patterns_, ))
    validate_TVerCancNFe_patterns_ = [
        ['^[1-9]{1}\\.[0-9]{2}$'],
        ['^[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}$|^[!-ÿ]{1}$']]
    ...
    def export(self, outfile, level, namespace_='', name_='TRetCancNFe',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='TRetCancNFe'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='',
                       name_='TRetCancNFe', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_TVerCancNFe(
                self.versao)    # validate type TVerCancNFe
...
class TEvento(GeneratedsSuper):
    ...
    def validate_TVerEvento(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_TVerEvento_patterns_, ))
    validate_TVerEvento_patterns_ = [
        ['^[1-9]{1}\\.[0-9]{2}$'],
        ['^[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}$|^[!-ÿ]{1}$']]
    ...
    def export(self, outfile, level, namespace_='', name_='TEvento',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level,
                         already_processed, namespace_='', name_='TEvento'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='',
                       name_='TEvento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.infEvento is not None:
            self.infEvento.export(
                outfile,
                level,
                namespace_,
                name_='infEvento',
...
class TRetEvento(GeneratedsSuper):
    ...
    def validate_TRetVerEvento(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_TRetVerEvento_patterns_, ))
    validate_TRetVerEvento_patterns_ = [
        ['^[1-9]{1}\\.[0-9]{2}$'],
        ['^[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}$|^[!-ÿ]{1}$']]
    ...
    def export(self, outfile, level, namespace_='', name_='TRetEvento',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level,
                         already_processed, namespace_='', name_='TRetEvento'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='',
                       name_='TRetEvento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            self.versao = value
            self.validate_TRetVerEvento(
                self.versao)    # validate type TRetVerEvento
...
class TProcEvento(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='',
               name_='TProcEvento', namespacedef_='', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='TProcEvento'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='',
                       name_='TProcEvento', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infProtType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='infProtType',
               namespacedef_=' xmlns:ds="http://www.w3.org/2000/09/xmldsig#" ', pretty_print=True):
...
class infCancType(GeneratedsSuper):
    ...
    def __init__(self, Id=None, tpAmb=None, verAplic=None, cStat=None,
                 xMotivo=None, cUF=None, chNFe=None, dhRecbto=None, nProt=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.tpAmb = tpAmb
        self.validate_TAmb(self.tpAmb)
    ...
    def export(self, outfile, level, namespace_='',
               name_='infCancType', namespacedef_='', pretty_print=True):
    ...
    def exportChildren(self, outfile, level, namespace_='',
                       name_='infCancType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infEventoType(GeneratedsSuper):
    ...
    def __init__(self, Id=None, cOrgao=None, tpAmb=None, CNPJ=None, CPF=None, chNFe=None,
                 dhEvento=None, tpEvento=None, nSeqEvento=None, verEvento=None, detEvento=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.cOrgao = cOrgao
    ...
    def validate_TCOrgaoIBGE(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            ...
            if not enumeration_respectee:
                warnings_.warn(
                    'Value "%(value)s" does not match xsd enumeration restriction on TCOrgaoIBGE' % {
        "value": value.encode("utf-8")})
    ...
    def validate_tpEventoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_tpEventoType_patterns_, ))
    ...
    def validate_nSeqEventoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_nSeqEventoType_patterns_, ))
    ...
    def export(self, outfile, level, namespace_='',
               name_='infEventoType', namespacedef_='', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='infEventoType'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(
                ' Id=%s' %
    ...
    def exportChildren(self, outfile, level, namespace_='',
                       name_='infEventoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.nSeqEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%snSeqEvento>%s</%snSeqEvento>%s' %
                (namespace_,
                 self.gds_encode(
                     self.gds_format_string(
             quote_xml(
                self.nSeqEvento),
            input_name='nSeqEvento')),
                    namespace_,
                    eol_))
        if self.verEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sverEvento>%s</%sverEvento>%s' %
                (namespace_,
                 self.gds_encode(
                     self.gds_format_string(
             quote_xml(
                self.verEvento),
            input_name='verEvento')),
                    namespace_,
                    eol_))
        if self.detEvento is not None:
            self.detEvento.export(
                outfile,
                level,
                namespace_,
                name_='detEvento',
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cOrgao':
            ...
            nSeqEvento_ = self.gds_validate_string(
                nSeqEvento_, node, 'nSeqEvento')
            self.nSeqEvento = nSeqEvento_
            # validate type nSeqEventoType
            self.validate_nSeqEventoType(self.nSeqEvento)
        elif nodeName_ == 'verEvento':
            verEvento_ = child_.text
            verEvento_ = self.gds_validate_string(
                verEvento_, node, 'verEvento')
...
class detEventoType(GeneratedsSuper):
    ...
    def set_anyAttributes_(
        self, anyAttributes_): self.anyAttributes_ = anyAttributes_
    ...
    def export(self, outfile, level, namespace_='',
               name_='detEventoType', namespacedef_='', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='detEventoType'):
        unique_counter = 0
    ...
    def exportChildren(self, outfile, level, namespace_='',
                       name_='detEventoType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infEventoType1(GeneratedsSuper):
    ...
    def __init__(self, Id=None, tpAmb=None, verAplic=None, cOrgao=None, cStat=None, xMotivo=None, chNFe=None, tpEvento=None,
                 xEvento=None, nSeqEvento=None, CNPJDest=None, CPFDest=None, emailDest=None, dhRegEvento=None, nProt=None):
        self.original_tagname_ = None
        self.Id = _cast(None, Id)
        self.tpAmb = tpAmb
        self.validate_TAmb(self.tpAmb)
    ...
    def validate_tpEventoType2(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_tpEventoType2_patterns_, ))
    ...
    def validate_xEventoType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 60:
                warnings_.warn(
                    'Value "%(value)s" does not match xsd maxLength restriction on xEventoType' % {
        "value": value})
            if len(str(value)) < 5:
                warnings_.warn(
                    'Value "%(value)s" does not match xsd minLength restriction on xEventoType' % {
        "value": value})
            if not self.gds_validate_simple_patterns(
                    self.validate_xEventoType_patterns_, value):
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_xEventoType_patterns_, ))
    validate_xEventoType_patterns_ = [
        ['^[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}$|^[!-ÿ]{1}$']]
    ...
    def validate_nSeqEventoType3(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_nSeqEventoType3_patterns_, ))
    ...
    def validate_emailDestType(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if len(str(value)) > 60:
                warnings_.warn(
                    'Value "%(value)s" does not match xsd maxLength restriction on emailDestType' % {
        "value": value})
            if len(str(value)) < 1:
                warnings_.warn(
                    'Value "%(value)s" does not match xsd minLength restriction on emailDestType' % {
        "value": value})
            if not self.gds_validate_simple_patterns(
                    self.validate_emailDestType_patterns_, value):
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_emailDestType_patterns_, ))
    validate_emailDestType_patterns_ = [
        ['^[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}$|^[!-ÿ]{1}$']]
    ...
    def export(self, outfile, level, namespace_='',
               name_='infEventoType1', namespacedef_='', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='infEventoType1'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(
                ' Id=%s' %
    ...
    def exportChildren(self, outfile, level, namespace_='',
                       name_='infEventoType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.emailDest is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%semailDest>%s</%semailDest>%s' %
                (namespace_,
                 self.gds_encode(
                     self.gds_format_string(
             quote_xml(
                self.emailDest),
            input_name='emailDest')),
                    namespace_,
                    eol_))
        if self.dhRegEvento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sdhRegEvento>%s</%sdhRegEvento>%s' %
                (namespace_,
                 self.gds_encode(
                     self.gds_format_string(
             quote_xml(
                self.dhRegEvento),
            input_name='dhRegEvento')),
                    namespace_,
                    eol_))
        if self.nProt is not None:
            showIndent(outfile, level, pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            emailDest_ = self.gds_validate_string(
                emailDest_, node, 'emailDest')
            self.emailDest = emailDest_
            # validate type emailDestType
            self.validate_emailDestType(self.emailDest)
        elif nodeName_ == 'dhRegEvento':
            dhRegEvento_ = child_.text
            dhRegEvento_ = self.gds_validate_string(
                dhRegEvento_, node, 'dhRegEvento')
...
GDSClassesMapping = {
    ...
    'detEvento': detEventoType,
    'evento': TEvento,
    'infCanc': infCancType,
    'infEvento': infEventoType1,
    'infProt': infProtType,
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from leiauteConsSitNFe import *\n\n')
        sys.stdout.write('import leiauteConsSitNFe as model_\n\n')
