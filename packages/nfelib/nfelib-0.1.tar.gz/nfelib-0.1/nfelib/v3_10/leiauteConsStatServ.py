...
#
# Generated Thu Nov  2 13:11:07 2017 by generateDS.py version 2.28b.
# Python 3.5.2 (default, Sep 14 2017, 22:51:06)  [GCC 5.4.0 20160609]
#
# Command line options:
#   ('-o', 'nfelib/v3_10/leiauteConsStatServ.py')
#
# Command line arguments:
#   schemas/v3_10/leiauteConsStatServ_v3.10.xsd
#
# Command line:
#   /home/rvalyi/DEV/generateds/generateDS.py -o "nfelib/v3_10/leiauteConsStatServ.py" schemas/v3_10/leiauteConsStatServ_v3.10.xsd
#
...
SimpleTypes = {
    "xObs": """Tipo Motivo""",
    "dhRetorno": """Data e Hora, formato UTC (AAAA-MM-DDThh:mm:ssTZD, onde TZD = +hh:mm ou -hh:mm)""",
...
class TConsStatServ(GeneratedsSuper):
    ...
    def validate_TVerConsStatServ(self, value):
        ...
        if value is not None and Validate_simpletypes_:
            if not self.gds_validate_simple_patterns(
                ...
                warnings_.warn(
                    'Value "%s" does not match xsd pattern restrictions: %s' %
                    (value.encode('utf-8'), self.validate_TVerConsStatServ_patterns_, ))
    validate_TVerConsStatServ_patterns_ = [['^3\\.10$']]
    ...
    def export(self, outfile, level, namespace_='',
               name_='TConsStatServ', namespacedef_='', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='TConsStatServ'):
    ...
    def exportChildren(self, outfile, level, namespace_='',
                       name_='TConsStatServ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'versao' not in already_processed:
            ...
            self.validate_TVerConsStatServ(
                self.versao)    # validate type TVerConsStatServ
...
class TRetConsStatServ(GeneratedsSuper):
    ...
    def __init__(self, versao=None, tpAmb=None, verAplic=None, cStat=None,
                 xMotivo=None, cUF=None, dhRecbto=None, tMed=None, dhRetorno=None, xObs=None):
        self.original_tagname_ = None
        self.versao = _cast(None, versao)
        self.tpAmb = tpAmb
        self.validate_TAmb(self.tpAmb)
    ...
    def export(self, outfile, level, namespace_='',
               name_='TRetConsStatServ', namespacedef_='', pretty_print=True):
    ...
    def exportAttributes(self, outfile, level, already_processed,
                         namespace_='', name_='TRetConsStatServ'):
        if self.versao is not None and 'versao' not in already_processed:
            already_processed.add('versao')
            outfile.write(' versao=%s' % (quote_attrib(self.versao), ))

    def exportChildren(self, outfile, level, namespace_='',
                       name_='TRetConsStatServ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.dhRetorno is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(
                '<%sdhRetorno>%s</%sdhRetorno>%s' %
                (namespace_,
                 self.gds_encode(
                     self.gds_format_string(
             quote_xml(
                self.dhRetorno),
            input_name='dhRetorno')),
                    namespace_,
                    eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'tpAmb':
            ...
            dhRetorno_ = self.gds_validate_string(
                dhRetorno_, node, 'dhRetorno')
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from leiauteConsStatServ import *\n\n')
        sys.stdout.write('import leiauteConsStatServ as model_\n\n')
