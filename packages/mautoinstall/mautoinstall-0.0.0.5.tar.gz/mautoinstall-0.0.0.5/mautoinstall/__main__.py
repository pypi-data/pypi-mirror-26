...
def __main() -> int:
    ...
    try:
        ...
        __print( "\nCHECK FAILED. YOU ARE NOT USING A UNICODE TERMINAL OR UNICODE IS MISCONFIGURED. PLEASE SWITCH TO A UNICODE TERMINAL OR ENABLE UNICODE." )
    ...
    if colorterm is not None:
        ...
        __print( "* CHECK FAILED: YOU ARE NOT USING A TRUE COLOUR TERMINAL OR TRUE COLOUR IS MISCONFIGURED. PLEASE SWITCH A TRUE COLOUR TERMINAL OR ENABLE 'COLORTERM'." )
    ...
    if from_pypi:
        for VARIABLE in from_pypi:
            ...
            if mode_install:
                __run( "USR", "sudo pip install{}".format( VARIABLE ) )
            elif mode_reinstall:
                __run( "US2", "sudo pip install {} --upgrade --force-reinstall".format( VARIABLE ) )
            elif mode_uninstall:
                __run( "US3", "sudo pip uninstall {}".format( VARIABLE ) )
            else:
    ...
    if from_bitbucket:
        for VARIABLE in from_bitbucket:
            ...
            if mode_install:
                ...
                __run( "REM", "sudo pip uninstall {}".format( VARIABLE ) )
